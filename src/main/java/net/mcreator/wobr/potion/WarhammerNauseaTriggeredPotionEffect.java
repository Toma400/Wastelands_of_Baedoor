...
public class WarhammerNauseaTriggeredPotionEffect extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warhammer_nausea_triggered")
	public static final Effect potion = null;
	public WarhammerNauseaTriggeredPotionEffect(WobrModElements instance) {
		super(instance, 2055);
