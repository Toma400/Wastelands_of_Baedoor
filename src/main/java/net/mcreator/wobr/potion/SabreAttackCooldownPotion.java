...
public class SabreAttackCooldownPotion extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sabre_attack_cooldown")
	public static final Effect potion = null;
	public SabreAttackCooldownPotion(WobrModElements instance) {
		super(instance, 1281);
	...
	public static class EffectCustom extends Effect {
		...
		public String getName() {
			return "effect.sabre_attack_cooldown";
		}
