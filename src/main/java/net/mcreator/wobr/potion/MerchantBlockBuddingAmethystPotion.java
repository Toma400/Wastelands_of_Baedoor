...
public class MerchantBlockBuddingAmethystPotion extends WobrModElements.ModElement {
	@ObjectHolder("wobr:merchant_block_budding_amethyst")
	public static final Effect potion = null;
	public MerchantBlockBuddingAmethystPotion(WobrModElements instance) {
		super(instance, 1316);
	...
	public static class EffectCustom extends Effect {
		...
		public String getName() {
			return "effect.merchant_block_budding_amethyst";
		}
