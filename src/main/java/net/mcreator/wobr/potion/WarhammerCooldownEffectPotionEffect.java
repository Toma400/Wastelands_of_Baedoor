...
public class WarhammerCooldownEffectPotionEffect extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warhammer_cooldown_effect")
	public static final Effect potion = null;
	public WarhammerCooldownEffectPotionEffect(WobrModElements instance) {
		super(instance, 2053);
