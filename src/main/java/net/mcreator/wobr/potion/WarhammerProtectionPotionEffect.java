...
public class WarhammerProtectionPotionEffect extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warhammer_protection")
	public static final Effect potion = null;
	public WarhammerProtectionPotionEffect(WobrModElements instance) {
		super(instance, 2051);
	...
	public static class EffectCustom extends Effect {
		...
		public String getName() {
			return "effect.warhammer_protection";
		}
