...
public class PlayerMessagePotionPotionEffect extends WobrModElements.ModElement {
	@ObjectHolder("wobr:player_message_potion")
	public static final Effect potion = null;
	public PlayerMessagePotionPotionEffect(WobrModElements instance) {
		super(instance, 1654);
	...
	public static class EffectCustom extends Effect {
		...
		public String getName() {
			return "effect.player_message_potion";
		}
