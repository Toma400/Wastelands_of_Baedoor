...
public class ModdedTagKillProcedure extends WobrModElements.ModElement {
	...
	public static boolean executeProcedure(Map<String, Object> dependencies) {
		...
		return (((((((EntityTypeTags.getCollection().getOrCreate(new ResourceLocation(("forge:avoider_mowzie").toLowerCase(java.util.Locale.ENGLISH)))
				...
				|| (EntityTypeTags.getCollection().getOrCreate(new ResourceLocation(("forge:avoider_desolat").toLowerCase(java.util.Locale.ENGLISH)))
						.contains(entity.getType())))
				|| ((EntityTypeTags.getCollection()
						...
						|| (EntityTypeTags.getCollection()
								...
								.contains(entity.getType()))))
				|| ((EntityTypeTags.getCollection().getOrCreate(new ResourceLocation(("forge:avoider_atum").toLowerCase(java.util.Locale.ENGLISH)))
						.contains(entity.getType()))
						|| ((EntityTypeTags.getCollection()
