...
public class OrmathTrade2Procedure extends WobrModElements.ModElement {
	public OrmathTrade2Procedure(WobrModElements instance) {
		super(instance, 1456);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure OrmathTrade2!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure OrmathTrade2!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure OrmathTrade2!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure OrmathTrade2!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure OrmathTrade2!");
			return;
		}
		...
		if (((entity instanceof PlayerEntity)
				? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(CookedTropicalFishItem.block, (int) (1)))
				: false)) {
			fish = (double) 0;
			{
				...
				if (_iitemhandlerref.get() != null) {
					for (int _idx = 0; _idx < _iitemhandlerref.get().getSlots(); _idx++) {
						...
						if ((new ItemStack(CookedTropicalFishItem.block, (int) (1)).getItem() == (itemstackiterator).getItem())) {
							fish = (double) ((fish) + (((itemstackiterator)).getCount()));
						}
					}
				}
			}
			if (((fish) >= 8)) {
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(CookedTropicalFishItem.block, (int) (1));
