...
public class ConfigManagerCopyProcedure extends WobrModElements.ModElement {
	public ConfigManagerCopyProcedure(WobrModElements instance) {
		super(instance, 2221);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WobrMod.LOGGER.warn("Failed to load dependency entity for procedure ConfigManagerCopy!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WobrMod.LOGGER.warn("Failed to load dependency world for procedure ConfigManagerCopy!");
			return;
		}
		...
		String save_file_path = "";
		{
			...
			ReverseOffhandProcedure.executeProcedure($_dependencies);
		}
