...
public class FirearmExperience2Procedure extends WobrModElements.ModElement {
	public FirearmExperience2Procedure(WobrModElements instance) {
		super(instance, 1164);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WobrMod.LOGGER.warn("Failed to load dependency entity for procedure FirearmExperience2!");
			return;
		}
		...
		if ((((entity.getCapability(WobrModVariables.PLAYER_VARIABLES_CAPABILITY, null)
				.orElse(new WobrModVariables.PlayerVariables())).Gun_Experience) < 100)) {
			{
				...
				if (_ent instanceof PlayerEntity) {
					...
					if (_so == null) {
						_so = _sc.addObjective("gun_xp_iterator", ScoreCriteria.DUMMY, new StringTextComponent("gun_xp_iterator"),
