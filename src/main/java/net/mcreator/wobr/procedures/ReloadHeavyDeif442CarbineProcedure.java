...
public class ReloadHeavyDeif442CarbineProcedure extends WobrModElements.ModElement {
	public ReloadHeavyDeif442CarbineProcedure(WobrModElements instance) {
		super(instance, 1746);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WobrMod.LOGGER.warn("Failed to load dependency entity for procedure ReloadHeavyDeif442Carbine!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WobrMod.LOGGER.warn("Failed to load dependency x for procedure ReloadHeavyDeif442Carbine!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WobrMod.LOGGER.warn("Failed to load dependency y for procedure ReloadHeavyDeif442Carbine!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WobrMod.LOGGER.warn("Failed to load dependency z for procedure ReloadHeavyDeif442Carbine!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WobrMod.LOGGER.warn("Failed to load dependency world for procedure ReloadHeavyDeif442Carbine!");
			return;
		}
			...
			if (((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(LargeBulletItem.block)) : false)) {
				if ((!(new Object() {
					...
					if (entity instanceof LivingEntity)
						((LivingEntity) entity)
								.addPotionEffect(new EffectInstance(SingleReloadTypePotionEffect.potion, (int) 50, (int) 1, (false), (false)));
				}
			} else {
