...
public class ShotRusticDeif444CarbineProcedure extends WobrModElements.ModElement {
	public ShotRusticDeif444CarbineProcedure(WobrModElements instance) {
		super(instance, 1711);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WobrMod.LOGGER.warn("Failed to load dependency entity for procedure ShotRusticDeif444Carbine!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				WobrMod.LOGGER.warn("Failed to load dependency itemstack for procedure ShotRusticDeif444Carbine!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WobrMod.LOGGER.warn("Failed to load dependency x for procedure ShotRusticDeif444Carbine!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WobrMod.LOGGER.warn("Failed to load dependency y for procedure ShotRusticDeif444Carbine!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WobrMod.LOGGER.warn("Failed to load dependency z for procedure ShotRusticDeif444Carbine!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WobrMod.LOGGER.warn("Failed to load dependency world for procedure ShotRusticDeif444Carbine!");
			return;
		}
					...
					if ((((itemstack).getOrCreateTag().getBoolean("jammed")) == (false))) {
						...
						if (entity instanceof LivingEntity) {
							...
							if (!_ent.world.isRemote) {
								BulletRangedItem.shoot(_ent.world, (LivingEntity) entity, new Random(), (float) 9, (float) 1, (int) 0);
							}
						}
