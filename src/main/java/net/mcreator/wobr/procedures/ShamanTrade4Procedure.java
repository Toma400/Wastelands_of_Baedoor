...
public class ShamanTrade4Procedure extends WobrModElements.ModElement {
	public ShamanTrade4Procedure(WobrModElements instance) {
		super(instance, 1443);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure ShamanTrade4!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure ShamanTrade4!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure ShamanTrade4!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure ShamanTrade4!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure ShamanTrade4!");
			return;
		}
		...
		if (((entity instanceof PlayerEntity)
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(CurareItem.block, (int) (1));
