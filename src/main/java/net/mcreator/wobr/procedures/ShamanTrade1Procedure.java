...
public class ShamanTrade1Procedure extends WobrModElements.ModElement {
	public ShamanTrade1Procedure(WobrModElements instance) {
		super(instance, 1088);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure ShamanTrade1!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure ShamanTrade1!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure ShamanTrade1!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure ShamanTrade1!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure ShamanTrade1!");
			return;
		}
		...
		if (((entity instanceof PlayerEntity)
			...
			if (entity instanceof PlayerEntity) {
				ItemStack _setstack = new ItemStack(GlisteringAshItem.block, (int) (1));
