...
public class ShotAyerSawedOffProcedure extends WobrModElements.ModElement {
	public ShotAyerSawedOffProcedure(WobrModElements instance) {
		super(instance, 1205);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure ShotAyerSawedOff!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				System.err.println("Failed to load dependency itemstack for procedure ShotAyerSawedOff!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure ShotAyerSawedOff!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure ShotAyerSawedOff!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure ShotAyerSawedOff!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure ShotAyerSawedOff!");
			return;
		}
			...
			if ((((itemstack).getOrCreateTag().getBoolean("jammed")) == (false))) {
				if ((((itemstack).getOrCreateTag().getDouble("Shoot_Mode")) == 1)) {
					...
					if (world instanceof World && !world.getWorld().isRemote && entity instanceof LivingEntity) {
						BulletRangedItem.shoot(world.getWorld(), (LivingEntity) entity, new Random(), (float) 2, (float) 4, (int) 0);
					}
					...
					if ((((itemstack).getOrCreateTag().getDouble("Ammo")) > 1)) {
						...
						if (world instanceof World && !world.getWorld().isRemote && entity instanceof LivingEntity) {
							BulletRangedItem.shoot(world.getWorld(), (LivingEntity) entity, new Random(), (float) 2, (float) 4, (int) 1);
						}
						if (world instanceof World && !world.getWorld().isRemote && entity instanceof LivingEntity) {
							BulletRangedItem.shoot(world.getWorld(), (LivingEntity) entity, new Random(), (float) 2, (float) 4, (int) 1);
						}
