	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				System.err.println("Failed to load dependency entity for procedure ShotLavaAmmoBox!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				System.err.println("Failed to load dependency itemstack for procedure ShotLavaAmmoBox!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure ShotLavaAmmoBox!");
			return;
		}
		...
		if ((((itemstack).getOrCreateTag().getDouble("Ammo")) >= 20)) {
			if ((((itemstack).getOrCreateTag().getDouble("Shoot_Mode")) == 1)) {
				if (world instanceof World && !world.getWorld().isRemote && entity instanceof LivingEntity) {
					AmmoBoxLavaProjectileItem.shoot(world.getWorld(), (LivingEntity) entity, new Random(), (float) 1, (float) 0, (int) 5);
				}
