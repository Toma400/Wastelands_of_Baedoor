...
public class ShotJitadoShotgunProcedure extends WobrModElements.ModElement {
	public ShotJitadoShotgunProcedure(WobrModElements instance) {
		super(instance, 928);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WobrMod.LOGGER.warn("Failed to load dependency entity for procedure ShotJitadoShotgun!");
			return;
		}
		if (dependencies.get("itemstack") == null) {
			if (!dependencies.containsKey("itemstack"))
				WobrMod.LOGGER.warn("Failed to load dependency itemstack for procedure ShotJitadoShotgun!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WobrMod.LOGGER.warn("Failed to load dependency x for procedure ShotJitadoShotgun!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WobrMod.LOGGER.warn("Failed to load dependency y for procedure ShotJitadoShotgun!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WobrMod.LOGGER.warn("Failed to load dependency z for procedure ShotJitadoShotgun!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WobrMod.LOGGER.warn("Failed to load dependency world for procedure ShotJitadoShotgun!");
			return;
		}
		...
		if ((WobrModVariables.MapVariables.get(world).KF_Wp_Gun_Enabled == (true))) {
			if (((((itemstack).getOrCreateTag().getDouble("Ammo")) > 0) || ((new Object() {
				...
				if ((((itemstack).getOrCreateTag().getBoolean("jammed")) == (false))) {
					...
					if (entity instanceof LivingEntity) {
						...
						if (!_ent.world.isRemote) {
							BulletRangedItem.shoot(_ent.world, (LivingEntity) entity, new Random(), (float) 4, (float) 9, (int) 2);
						}
					}
					if (!world.getWorld().isRemote) {
						world.playSound(null, new BlockPos((int) x, (int) y, (int) z), (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("wobr:jitado_shotgun_shot")), SoundCategory.NEUTRAL, (float) 1, (float) 1);
					} else {
						world.getWorld().playSound(x, y, z,
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
										.getValue(new ResourceLocation("wobr:jitado_shotgun_shot")),
				...
				}
				{
					...
					ShotDelay30tProcedure.executeProcedure($_dependencies);
				}
				{
