...
public class StrippedSpicewoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_spicewood_wooden_stairs")
	public static final Block block = null;
	public StrippedSpicewoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 531);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_spicewood_wooden_stairs");
		}
