...
public class BirchFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_orange_stained_glass")
	public static final Block block = null;
	public BirchFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_orange_stained_glass");
		}
