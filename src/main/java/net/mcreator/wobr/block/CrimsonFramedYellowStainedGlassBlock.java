...
public class CrimsonFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_yellow_stained_glass")
	public static final Block block = null;
	public CrimsonFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 350);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_yellow_stained_glass");
		}
