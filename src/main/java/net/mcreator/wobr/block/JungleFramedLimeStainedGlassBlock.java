...
public class JungleFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_lime_stained_glass")
	public static final Block block = null;
	public JungleFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 370);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_lime_stained_glass");
		}
