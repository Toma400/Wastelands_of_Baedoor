...
public class NutwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:nutwood_wooden_stairs")
	public static final Block block = null;
	public NutwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 663);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("nutwood_wooden_stairs");
		}
