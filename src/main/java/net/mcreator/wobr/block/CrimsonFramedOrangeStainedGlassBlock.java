...
public class CrimsonFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_orange_stained_glass")
	public static final Block block = null;
	public CrimsonFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 340);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_orange_stained_glass");
		}
