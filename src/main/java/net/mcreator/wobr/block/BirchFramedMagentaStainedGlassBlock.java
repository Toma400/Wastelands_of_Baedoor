...
public class BirchFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_magenta_stained_glass")
	public static final Block block = null;
	public BirchFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 328);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_magenta_stained_glass");
		}
