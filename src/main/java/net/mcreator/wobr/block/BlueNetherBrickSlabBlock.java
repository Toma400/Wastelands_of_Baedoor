...
public class BlueNetherBrickSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:blue_nether_brick_slab")
	public static final Block block = null;
	public BlueNetherBrickSlabBlock(WobrModElements instance) {
		super(instance, 213);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_nether_brick_slab");
		}
