...
public class BlueShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:blue_shroomed_wooden_slab")
	public static final Block block = null;
	public BlueShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 648);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_shroomed_wooden_slab");
		}
