...
public class SandyBirchFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_lime_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 423);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_lime_stained_glass");
		}
