...
public class OakFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_cyan_stained_glass")
	public static final Block block = null;
	public OakFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 381);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_cyan_stained_glass");
		}
