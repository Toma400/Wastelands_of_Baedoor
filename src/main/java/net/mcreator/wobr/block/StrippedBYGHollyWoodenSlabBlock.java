...
public class StrippedBYGHollyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_holly_wooden_slab")
	public static final Block block = null;
	public StrippedBYGHollyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 558);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_holly_wooden_slab");
		}
