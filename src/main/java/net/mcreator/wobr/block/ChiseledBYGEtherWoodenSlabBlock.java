...
public class ChiseledBYGEtherWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_ether_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGEtherWoodenSlabBlock(WobrModElements instance) {
		super(instance, 540);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_ether_wooden_slab");
		}
