...
public class SpruceFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_lime_stained_glass")
	public static final Block block = null;
	public SpruceFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 434);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_lime_stained_glass");
		}
