...
public class CrackedLavaBlockBlock extends WobrModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(25f, 10f).lightValue(3).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("cracked_lava_block");
		}
