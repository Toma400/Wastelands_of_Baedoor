...
public class ChiseledBYGMangroveWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_mangrove_wood")
	public static final Block block = null;
	public ChiseledBYGMangroveWoodBlock(WobrModElements instance) {
		super(instance, 585);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_mangrove_wood");
		}
