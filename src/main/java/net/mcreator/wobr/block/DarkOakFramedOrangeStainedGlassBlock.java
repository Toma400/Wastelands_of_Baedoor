...
public class DarkOakFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_orange_stained_glass")
	public static final Block block = null;
	public DarkOakFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 361);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_orange_stained_glass");
		}
