...
public class WarpedFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_yellow_stained_glass")
	public static final Block block = null;
	public WarpedFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 457);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_yellow_stained_glass");
		}
