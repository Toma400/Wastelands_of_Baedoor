...
public class BlackHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:black_horizontal_stained_glass_pane")
	public static final Block block = null;
	public BlackHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 267);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("black_horizontal_stained_glass_pane");
		}
