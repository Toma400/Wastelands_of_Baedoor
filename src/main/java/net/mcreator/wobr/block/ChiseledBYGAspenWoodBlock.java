...
public class ChiseledBYGAspenWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_aspen_wood")
	public static final Block block = null;
	public ChiseledBYGAspenWoodBlock(WobrModElements instance) {
		super(instance, 2195);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_aspen_wood");
		}
