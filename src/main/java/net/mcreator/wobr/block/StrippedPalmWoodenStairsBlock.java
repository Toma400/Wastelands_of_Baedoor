...
public class StrippedPalmWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_palm_wooden_stairs")
	public static final Block block = null;
	public StrippedPalmWoodenStairsBlock(WobrModElements instance) {
		super(instance, 479);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_palm_wooden_stairs");
		}
