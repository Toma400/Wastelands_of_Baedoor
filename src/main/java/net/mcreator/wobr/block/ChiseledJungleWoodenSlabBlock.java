...
public class ChiseledJungleWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_jungle_wooden_slab")
	public static final Block block = null;
	public ChiseledJungleWoodenSlabBlock(WobrModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_jungle_wooden_slab");
		}
