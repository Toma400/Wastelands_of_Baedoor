...
public class StrippedBYGBaobabWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_baobab_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGBaobabWoodenStairsBlock(WobrModElements instance) {
		super(instance, 503);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_baobab_wooden_stairs");
		}
