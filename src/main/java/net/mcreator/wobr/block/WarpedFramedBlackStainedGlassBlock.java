...
public class WarpedFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_black_stained_glass")
	public static final Block block = null;
	public WarpedFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 447);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_black_stained_glass");
		}
