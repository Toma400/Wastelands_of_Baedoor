...
public class RedAcaciaFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_orange_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 409);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_orange_stained_glass");
		}
