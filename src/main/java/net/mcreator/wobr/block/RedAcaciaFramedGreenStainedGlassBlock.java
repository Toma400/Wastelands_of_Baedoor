...
public class RedAcaciaFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_green_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 376);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_green_stained_glass");
		}
