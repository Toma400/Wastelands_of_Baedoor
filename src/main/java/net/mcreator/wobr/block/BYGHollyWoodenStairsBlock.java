...
public class BYGHollyWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_holly_wooden_stairs")
	public static final Block block = null;
	public BYGHollyWoodenStairsBlock(WobrModElements instance) {
		super(instance, 555);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_holly_wooden_stairs");
		}
