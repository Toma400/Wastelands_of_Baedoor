...
public class SandyBirchFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_pink_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 418);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_pink_stained_glass");
		}
