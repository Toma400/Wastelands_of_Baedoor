...
public class BambooFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_magenta_stained_glass")
	public static final Block block = null;
	public BambooFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_magenta_stained_glass");
		}
