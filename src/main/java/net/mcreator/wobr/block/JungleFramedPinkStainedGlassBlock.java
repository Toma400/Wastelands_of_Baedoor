...
public class JungleFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_pink_stained_glass")
	public static final Block block = null;
	public JungleFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 373);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_pink_stained_glass");
		}
