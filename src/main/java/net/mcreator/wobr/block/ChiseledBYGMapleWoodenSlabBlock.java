...
public class ChiseledBYGMapleWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_maple_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGMapleWoodenSlabBlock(WobrModElements instance) {
		super(instance, 596);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_maple_wooden_slab");
		}
