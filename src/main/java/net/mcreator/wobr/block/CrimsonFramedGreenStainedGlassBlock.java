...
public class CrimsonFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_green_stained_glass")
	public static final Block block = null;
	public CrimsonFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 340);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_green_stained_glass");
		}
