...
public class StrippedJuniperWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_juniper_wooden_stairs")
	public static final Block block = null;
	public StrippedJuniperWoodenStairsBlock(WobrModElements instance) {
		super(instance, 500);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_juniper_wooden_stairs");
		}
