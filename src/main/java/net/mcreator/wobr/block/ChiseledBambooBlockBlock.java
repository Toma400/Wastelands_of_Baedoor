...
public class ChiseledBambooBlockBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_bamboo_block")
	public static final Block block = null;
	public ChiseledBambooBlockBlock(WobrModElements instance) {
		super(instance, 178);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_bamboo_block");
		}
