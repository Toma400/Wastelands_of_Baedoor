...
public class ChiseledStrippedBYGPalmWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_byg_palm_wood")
	public static final Block block = null;
	public ChiseledStrippedBYGPalmWoodBlock(WobrModElements instance) {
		super(instance, 613);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_byg_palm_wood");
		}
