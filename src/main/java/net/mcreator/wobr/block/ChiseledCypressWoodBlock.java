...
public class ChiseledCypressWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_cypress_wood")
	public static final Block block = null;
	public ChiseledCypressWoodBlock(WobrModElements instance) {
		super(instance, 533);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_cypress_wood");
		}
