...
public class LightedBaedoorGoldenPlateBlock extends WobrModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 1f).lightValue(15).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE).notSolid());
			setRegistryName("lighted_baedoor_golden_plate");
		}
