...
public class ChiseledBYGFirWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_fir_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGFirWoodenSlabBlock(WobrModElements instance) {
		super(instance, 547);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_fir_wooden_slab");
		}
