...
public class ChiseledStrippedBYGAspenWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_byg_aspen_wood")
	public static final Block block = null;
	public ChiseledStrippedBYGAspenWoodBlock(WobrModElements instance) {
		super(instance, 2200);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_byg_aspen_wood");
		}
