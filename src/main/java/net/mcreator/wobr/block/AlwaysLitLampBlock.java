...
public class AlwaysLitLampBlock extends WobrModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.GLASS).hardnessAndResistance(1f, 4f).lightValue(15).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("always_lit_lamp");
		}
