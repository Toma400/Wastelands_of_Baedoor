...
public class JungleFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_gray_stained_glass")
	public static final Block block = null;
	public JungleFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 366);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_gray_stained_glass");
		}
