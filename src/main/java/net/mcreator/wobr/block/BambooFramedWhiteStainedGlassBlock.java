...
public class BambooFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_white_stained_glass")
	public static final Block block = null;
	public BambooFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_white_stained_glass");
		}
