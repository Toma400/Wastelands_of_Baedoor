...
public class ChiseledBYGFirWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_fir_wood")
	public static final Block block = null;
	public ChiseledBYGFirWoodBlock(WobrModElements instance) {
		super(instance, 545);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_fir_wood");
		}
