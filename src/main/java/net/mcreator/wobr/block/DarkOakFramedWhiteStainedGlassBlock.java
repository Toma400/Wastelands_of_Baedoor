...
public class DarkOakFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_white_stained_glass")
	public static final Block block = null;
	public DarkOakFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 365);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_white_stained_glass");
		}
