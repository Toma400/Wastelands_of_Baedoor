...
public class BYGRedwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_redwood_wooden_slab")
	public static final Block block = null;
	public BYGRedwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 626);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_redwood_wooden_slab");
		}
