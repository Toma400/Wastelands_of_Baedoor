...
public class DarkLapisCrystalBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_lapis_crystal")
	public static final Block block = null;
	public DarkLapisCrystalBlock(WobrModElements instance) {
		super(instance, 201);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dark_lapis_crystal");
		}
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Crystallized essence of lapis, pulsating light from its very core"));
		}
