...
public class StrippedJungleWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_jungle_wooden_slab")
	public static final Block block = null;
	public StrippedJungleWoodenSlabBlock(WobrModElements instance) {
		super(instance, 102);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_jungle_wooden_slab");
		}
