...
public class StrippedBYGPaloVerdeWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_palo_verde_wooden_slab")
	public static final Block block = null;
	public StrippedBYGPaloVerdeWoodenSlabBlock(WobrModElements instance) {
		super(instance, 622);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_palo_verde_wooden_slab");
		}
