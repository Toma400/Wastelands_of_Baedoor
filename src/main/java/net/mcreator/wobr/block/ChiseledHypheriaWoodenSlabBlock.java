...
public class ChiseledHypheriaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_hypheria_wooden_slab")
	public static final Block block = null;
	public ChiseledHypheriaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 553);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_hypheria_wooden_slab");
		}
