...
public class StrippedOakWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_oak_wooden_slab")
	public static final Block block = null;
	public StrippedOakWoodenSlabBlock(WobrModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_oak_wooden_slab");
		}
