...
public class StrippedCucturWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_cuctur_wooden_slab")
	public static final Block block = null;
	public StrippedCucturWoodenSlabBlock(WobrModElements instance) {
		super(instance, 558);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_cuctur_wooden_slab");
		}
