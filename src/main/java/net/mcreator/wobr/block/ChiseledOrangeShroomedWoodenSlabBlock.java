...
public class ChiseledOrangeShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_orange_shroomed_wooden_slab")
	public static final Block block = null;
	public ChiseledOrangeShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 511);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_orange_shroomed_wooden_slab");
		}
