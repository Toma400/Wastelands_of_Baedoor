...
public class ChiseledCucturWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_cuctur_wooden_slab")
	public static final Block block = null;
	public ChiseledCucturWoodenSlabBlock(WobrModElements instance) {
		super(instance, 594);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_cuctur_wooden_slab");
		}
