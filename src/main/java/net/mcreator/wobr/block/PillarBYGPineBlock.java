...
public class PillarBYGPineBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:pillar_byg_pine")
	public static final Block block = null;
	public PillarBYGPineBlock(WobrModElements instance) {
		super(instance, 2212);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("pillar_byg_pine");
		}
