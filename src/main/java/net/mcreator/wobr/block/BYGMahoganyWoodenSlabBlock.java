...
public class BYGMahoganyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_mahogany_wooden_slab")
	public static final Block block = null;
	public BYGMahoganyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 578);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_mahogany_wooden_slab");
		}
