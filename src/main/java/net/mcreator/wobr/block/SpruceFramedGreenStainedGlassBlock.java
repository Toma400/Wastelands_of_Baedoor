...
public class SpruceFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_green_stained_glass")
	public static final Block block = null;
	public SpruceFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 408);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_green_stained_glass");
		}
