...
public class MagentaHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:magenta_horizontal_stained_glass_pane")
	public static final Block block = null;
	public MagentaHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 280);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("magenta_horizontal_stained_glass_pane");
		}
