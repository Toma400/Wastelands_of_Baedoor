...
public class DarkOakFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_lime_stained_glass")
	public static final Block block = null;
	public DarkOakFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_lime_stained_glass");
		}
