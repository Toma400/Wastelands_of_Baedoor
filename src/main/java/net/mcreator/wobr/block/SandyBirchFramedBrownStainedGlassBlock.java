...
public class SandyBirchFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_brown_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 389);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_brown_stained_glass");
		}
