...
public class TsuaBlock extends WobrModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void addInformation(ItemStack itemstack, IBlockReader world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("WesternWald's one of the most known farmable plants, used to obtain ink by natives"));
		}
