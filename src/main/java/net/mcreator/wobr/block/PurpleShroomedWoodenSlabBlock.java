...
public class PurpleShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:purple_shroomed_wooden_slab")
	public static final Block block = null;
	public PurpleShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 552);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_shroomed_wooden_slab");
		}
