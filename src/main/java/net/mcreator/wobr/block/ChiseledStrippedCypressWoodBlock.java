...
public class ChiseledStrippedCypressWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_cypress_wood")
	public static final Block block = null;
	public ChiseledStrippedCypressWoodBlock(WobrModElements instance) {
		super(instance, 537);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_cypress_wood");
		}
