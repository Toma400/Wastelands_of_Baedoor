...
public class StrippedSpruceWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_spruce_wooden_stairs")
	public static final Block block = null;
	public StrippedSpruceWoodenStairsBlock(WobrModElements instance) {
		super(instance, 128);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_spruce_wooden_stairs");
		}
