...
public class JungleFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_brown_stained_glass")
	public static final Block block = null;
	public JungleFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 369);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_brown_stained_glass");
		}
