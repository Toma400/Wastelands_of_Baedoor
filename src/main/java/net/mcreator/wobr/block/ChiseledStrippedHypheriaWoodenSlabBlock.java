...
public class ChiseledStrippedHypheriaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_hypheria_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedHypheriaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 647);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_hypheria_wooden_slab");
		}
