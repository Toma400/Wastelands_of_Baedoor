...
public class BYGPalmWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_palm_wooden_stairs")
	public static final Block block = null;
	public BYGPalmWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1907);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_palm_wooden_stairs");
		}
