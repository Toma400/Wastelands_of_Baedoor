...
public class ChiseledBambooSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_bamboo_slab")
	public static final Block block = null;
	public ChiseledBambooSlabBlock(WobrModElements instance) {
		super(instance, 179);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_bamboo_slab");
		}
