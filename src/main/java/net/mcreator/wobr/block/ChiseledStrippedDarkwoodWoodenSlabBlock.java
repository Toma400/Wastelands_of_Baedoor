...
public class ChiseledStrippedDarkwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_darkwood_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedDarkwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 712);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_darkwood_wooden_slab");
		}
