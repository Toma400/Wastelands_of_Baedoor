...
public class PillarAcaciaBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:pillar_acacia")
	public static final Block block = null;
	public PillarAcaciaBlock(WobrModElements instance) {
		super(instance, 143);
	}
