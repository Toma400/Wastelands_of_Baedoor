...
public class DarkOakFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_light_gray_stained_glass")
	public static final Block block = null;
	public DarkOakFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 358);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_light_gray_stained_glass");
		}
