...
public class JungleFramedLightBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_light_blue_stained_glass")
	public static final Block block = null;
	public JungleFramedLightBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 368);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_light_blue_stained_glass");
		}
