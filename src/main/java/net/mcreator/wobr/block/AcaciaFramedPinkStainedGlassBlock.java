...
public class AcaciaFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_pink_stained_glass")
	public static final Block block = null;
	public AcaciaFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 293);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_pink_stained_glass");
		}
