...
public class RedAcaciaFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_pink_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 410);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_pink_stained_glass");
		}
