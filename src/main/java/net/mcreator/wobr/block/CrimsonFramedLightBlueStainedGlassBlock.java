...
public class CrimsonFramedLightBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_light_blue_stained_glass")
	public static final Block block = null;
	public CrimsonFramedLightBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 313);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_light_blue_stained_glass");
		}
