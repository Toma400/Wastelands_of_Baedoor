...
public class BYGPineWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_pine_wooden_slab")
	public static final Block block = null;
	public BYGPineWoodenSlabBlock(WobrModElements instance) {
		super(instance, 2203);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_pine_wooden_slab");
		}
