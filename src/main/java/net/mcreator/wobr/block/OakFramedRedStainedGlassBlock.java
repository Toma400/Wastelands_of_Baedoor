...
public class OakFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_red_stained_glass")
	public static final Block block = null;
	public OakFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 396);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_red_stained_glass");
		}
