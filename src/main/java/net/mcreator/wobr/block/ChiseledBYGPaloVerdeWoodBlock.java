...
public class ChiseledBYGPaloVerdeWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_palo_verde_wood")
	public static final Block block = null;
	public ChiseledBYGPaloVerdeWoodBlock(WobrModElements instance) {
		super(instance, 1918);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_palo_verde_wood");
		}
