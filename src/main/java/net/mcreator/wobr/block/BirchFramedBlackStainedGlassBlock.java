...
public class BirchFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_black_stained_glass")
	public static final Block block = null;
	public BirchFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_black_stained_glass");
		}
