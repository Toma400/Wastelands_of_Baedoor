...
public class OakFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_brown_stained_glass")
	public static final Block block = null;
	public OakFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 380);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_brown_stained_glass");
		}
