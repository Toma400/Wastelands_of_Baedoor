...
public class ChiseledBYGMahoganyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_mahogany_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGMahoganyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 580);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_mahogany_wooden_slab");
		}
