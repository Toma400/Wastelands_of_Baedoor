...
public class BirchFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_pink_stained_glass")
	public static final Block block = null;
	public BirchFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_pink_stained_glass");
		}
