...
public class ChiseledStrippedPalmWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_palm_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedPalmWoodenSlabBlock(WobrModElements instance) {
		super(instance, 478);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_palm_wooden_slab");
		}
