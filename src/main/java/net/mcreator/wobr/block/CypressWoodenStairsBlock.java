...
public class CypressWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cypress_wooden_stairs")
	public static final Block block = null;
	public CypressWoodenStairsBlock(WobrModElements instance) {
		super(instance, 679);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cypress_wooden_stairs");
		}
