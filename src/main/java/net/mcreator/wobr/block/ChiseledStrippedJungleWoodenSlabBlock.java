...
public class ChiseledStrippedJungleWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_jungle_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedJungleWoodenSlabBlock(WobrModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_jungle_wooden_slab");
		}
