...
public class ChiseledBYGNightshadeWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_nightshade_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGNightshadeWoodenSlabBlock(WobrModElements instance) {
		super(instance, 604);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_nightshade_wooden_slab");
		}
