...
public class ChiseledBYGMangroveWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_mangrove_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGMangroveWoodenSlabBlock(WobrModElements instance) {
		super(instance, 587);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_mangrove_wooden_slab");
		}
