...
public class StrippedNutwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_nutwood_wooden_stairs")
	public static final Block block = null;
	public StrippedNutwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 528);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_nutwood_wooden_stairs");
		}
