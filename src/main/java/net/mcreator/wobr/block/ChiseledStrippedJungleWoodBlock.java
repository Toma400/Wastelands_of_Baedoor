...
public class ChiseledStrippedJungleWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_jungle_wood")
	public static final Block block = null;
	public ChiseledStrippedJungleWoodBlock(WobrModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_jungle_wood");
		}
