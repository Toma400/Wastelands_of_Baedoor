...
public class OakFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_green_stained_glass")
	public static final Block block = null;
	public OakFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 387);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_green_stained_glass");
		}
