...
public class BrownShroomedWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:brown_shroomed_wooden_stairs")
	public static final Block block = null;
	public BrownShroomedWoodenStairsBlock(WobrModElements instance) {
		super(instance, 538);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_shroomed_wooden_stairs");
		}
