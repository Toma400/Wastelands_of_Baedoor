...
public class SandyBirchFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_black_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 407);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_black_stained_glass");
		}
