...
public class SpruceFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_purple_stained_glass")
	public static final Block block = null;
	public SpruceFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 438);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_purple_stained_glass");
		}
