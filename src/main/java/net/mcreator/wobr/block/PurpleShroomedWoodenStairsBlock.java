...
public class PurpleShroomedWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:purple_shroomed_wooden_stairs")
	public static final Block block = null;
	public PurpleShroomedWoodenStairsBlock(WobrModElements instance) {
		super(instance, 610);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_shroomed_wooden_stairs");
		}
