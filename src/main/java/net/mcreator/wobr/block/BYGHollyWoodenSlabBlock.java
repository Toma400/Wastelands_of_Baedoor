...
public class BYGHollyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_holly_wooden_slab")
	public static final Block block = null;
	public BYGHollyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 554);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_holly_wooden_slab");
		}
