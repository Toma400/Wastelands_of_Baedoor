...
public class BYGCypressWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_cypress_wooden_slab")
	public static final Block block = null;
	public BYGCypressWoodenSlabBlock(WobrModElements instance) {
		super(instance, 522);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_cypress_wooden_slab");
		}
