...
public class CucturWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cuctur_wooden_stairs")
	public static final Block block = null;
	public CucturWoodenStairsBlock(WobrModElements instance) {
		super(instance, 593);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cuctur_wooden_stairs");
		}
