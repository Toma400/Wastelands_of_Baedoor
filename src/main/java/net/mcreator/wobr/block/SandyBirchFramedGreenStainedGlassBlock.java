...
public class SandyBirchFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_green_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 415);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_green_stained_glass");
		}
