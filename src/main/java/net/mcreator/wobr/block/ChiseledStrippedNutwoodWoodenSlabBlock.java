...
public class ChiseledStrippedNutwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_nutwood_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedNutwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 619);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_nutwood_wooden_slab");
		}
