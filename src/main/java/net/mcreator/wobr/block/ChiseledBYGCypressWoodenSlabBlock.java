...
public class ChiseledBYGCypressWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_cypress_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGCypressWoodenSlabBlock(WobrModElements instance) {
		super(instance, 523);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_cypress_wooden_slab");
		}
