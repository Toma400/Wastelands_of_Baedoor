...
public class StrippedBYGCikaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_cika_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGCikaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 519);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_cika_wooden_stairs");
		}
