...
public class StrippedBYGEbonyWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_ebony_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGEbonyWoodenStairsBlock(WobrModElements instance) {
		super(instance, 535);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_ebony_wooden_stairs");
		}
