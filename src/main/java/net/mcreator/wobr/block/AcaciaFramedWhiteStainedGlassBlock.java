...
public class AcaciaFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_white_stained_glass")
	public static final Block block = null;
	public AcaciaFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 300);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_white_stained_glass");
		}
