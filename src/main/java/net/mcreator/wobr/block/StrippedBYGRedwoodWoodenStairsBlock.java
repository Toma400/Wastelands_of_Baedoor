...
public class StrippedBYGRedwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_redwood_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGRedwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1932);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_redwood_wooden_stairs");
		}
