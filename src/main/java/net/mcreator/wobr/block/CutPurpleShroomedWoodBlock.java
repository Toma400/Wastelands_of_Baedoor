...
public class CutPurpleShroomedWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cut_purple_shroomed_wood")
	public static final Block block = null;
	public CutPurpleShroomedWoodBlock(WobrModElements instance) {
		super(instance, 517);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_purple_shroomed_wood");
		}
