...
public class BYGMapleWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_maple_wooden_slab")
	public static final Block block = null;
	public BYGMapleWoodenSlabBlock(WobrModElements instance) {
		super(instance, 1886);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_maple_wooden_slab");
		}
