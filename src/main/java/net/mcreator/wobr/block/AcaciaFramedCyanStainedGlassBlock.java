...
public class AcaciaFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_cyan_stained_glass")
	public static final Block block = null;
	public AcaciaFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 282);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_cyan_stained_glass");
		}
