...
public class BYGMangroveWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_mangrove_wooden_stairs")
	public static final Block block = null;
	public BYGMangroveWoodenStairsBlock(WobrModElements instance) {
		super(instance, 587);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_mangrove_wooden_stairs");
		}
