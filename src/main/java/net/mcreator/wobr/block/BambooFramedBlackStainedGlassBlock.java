...
public class BambooFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_black_stained_glass")
	public static final Block block = null;
	public BambooFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 298);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_black_stained_glass");
		}
