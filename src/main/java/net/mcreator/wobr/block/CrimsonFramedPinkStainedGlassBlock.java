...
public class CrimsonFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_pink_stained_glass")
	public static final Block block = null;
	public CrimsonFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 338);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_pink_stained_glass");
		}
