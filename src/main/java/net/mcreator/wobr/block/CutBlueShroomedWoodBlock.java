...
public class CutBlueShroomedWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cut_blue_shroomed_wood")
	public static final Block block = null;
	public CutBlueShroomedWoodBlock(WobrModElements instance) {
		super(instance, 646);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_blue_shroomed_wood");
		}
