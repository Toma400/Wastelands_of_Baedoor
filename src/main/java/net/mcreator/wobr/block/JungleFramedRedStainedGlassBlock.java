...
public class JungleFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_red_stained_glass")
	public static final Block block = null;
	public JungleFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 380);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_red_stained_glass");
		}
