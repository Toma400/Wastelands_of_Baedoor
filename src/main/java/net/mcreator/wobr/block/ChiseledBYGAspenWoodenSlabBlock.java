...
public class ChiseledBYGAspenWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_aspen_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGAspenWoodenSlabBlock(WobrModElements instance) {
		super(instance, 2196);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_aspen_wooden_slab");
		}
