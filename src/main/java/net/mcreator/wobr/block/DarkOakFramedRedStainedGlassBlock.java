...
public class DarkOakFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_red_stained_glass")
	public static final Block block = null;
	public DarkOakFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 356);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_red_stained_glass");
		}
