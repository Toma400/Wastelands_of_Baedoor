...
public class PurpleHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:purple_horizontal_stained_glass_pane")
	public static final Block block = null;
	public PurpleHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 272);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("purple_horizontal_stained_glass_pane");
		}
