...
public class ChiseledStrippedCucturWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_cuctur_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedCucturWoodenSlabBlock(WobrModElements instance) {
		super(instance, 704);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_cuctur_wooden_slab");
		}
