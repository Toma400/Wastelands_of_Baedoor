...
public class BYGPaloVerdeWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_palo_verde_wooden_stairs")
	public static final Block block = null;
	public BYGPaloVerdeWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1917);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_palo_verde_wooden_stairs");
		}
