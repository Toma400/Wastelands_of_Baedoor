...
public class RedAcaciaFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_black_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 371);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_black_stained_glass");
		}
