...
public class CrimsonFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_red_stained_glass")
	public static final Block block = null;
	public CrimsonFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 320);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_red_stained_glass");
		}
