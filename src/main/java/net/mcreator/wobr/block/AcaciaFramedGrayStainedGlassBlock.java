...
public class AcaciaFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_gray_stained_glass")
	public static final Block block = null;
	public AcaciaFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 286);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_gray_stained_glass");
		}
