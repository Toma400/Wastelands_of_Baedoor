...
public class AcaciaFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_yellow_stained_glass")
	public static final Block block = null;
	public AcaciaFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 297);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_yellow_stained_glass");
		}
