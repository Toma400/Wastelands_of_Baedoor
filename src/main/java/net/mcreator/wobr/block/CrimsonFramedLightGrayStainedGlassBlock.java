...
public class CrimsonFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_light_gray_stained_glass")
	public static final Block block = null;
	public CrimsonFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 337);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_light_gray_stained_glass");
		}
