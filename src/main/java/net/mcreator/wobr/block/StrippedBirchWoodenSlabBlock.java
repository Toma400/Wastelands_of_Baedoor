...
public class StrippedBirchWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_birch_wooden_slab")
	public static final Block block = null;
	public StrippedBirchWoodenSlabBlock(WobrModElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_birch_wooden_slab");
		}
