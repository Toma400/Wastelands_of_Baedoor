...
public class CutBrownShroomedWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cut_brown_shroomed_wood")
	public static final Block block = null;
	public CutBrownShroomedWoodBlock(WobrModElements instance) {
		super(instance, 502);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_brown_shroomed_wood");
		}
