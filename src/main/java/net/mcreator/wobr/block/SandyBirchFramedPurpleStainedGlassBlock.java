...
public class SandyBirchFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_purple_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 399);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_purple_stained_glass");
		}
