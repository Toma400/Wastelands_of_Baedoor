...
public class CrimsonFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_purple_stained_glass")
	public static final Block block = null;
	public CrimsonFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_purple_stained_glass");
		}
