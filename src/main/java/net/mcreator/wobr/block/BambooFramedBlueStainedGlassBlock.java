...
public class BambooFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_blue_stained_glass")
	public static final Block block = null;
	public BambooFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_blue_stained_glass");
		}
