...
public class BambooFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_gray_stained_glass")
	public static final Block block = null;
	public BambooFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_gray_stained_glass");
		}
