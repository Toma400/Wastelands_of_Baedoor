...
public class StrippedBYGLamentWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_lament_wooden_slab")
	public static final Block block = null;
	public StrippedBYGLamentWoodenSlabBlock(WobrModElements instance) {
		super(instance, 573);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_lament_wooden_slab");
		}
