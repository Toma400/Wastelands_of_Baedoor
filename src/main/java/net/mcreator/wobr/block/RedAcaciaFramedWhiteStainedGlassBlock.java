...
public class RedAcaciaFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_white_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 413);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_white_stained_glass");
		}
