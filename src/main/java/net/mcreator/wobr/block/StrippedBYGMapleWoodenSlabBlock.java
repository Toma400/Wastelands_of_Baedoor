...
public class StrippedBYGMapleWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_maple_wooden_slab")
	public static final Block block = null;
	public StrippedBYGMapleWoodenSlabBlock(WobrModElements instance) {
		super(instance, 1891);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_maple_wooden_slab");
		}
