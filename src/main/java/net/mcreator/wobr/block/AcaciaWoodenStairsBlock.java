...
public class AcaciaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_wooden_stairs")
	public static final Block block = null;
	public AcaciaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 116);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_wooden_stairs");
		}
