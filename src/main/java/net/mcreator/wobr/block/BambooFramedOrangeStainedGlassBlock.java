...
public class BambooFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_orange_stained_glass")
	public static final Block block = null;
	public BambooFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 285);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_orange_stained_glass");
		}
