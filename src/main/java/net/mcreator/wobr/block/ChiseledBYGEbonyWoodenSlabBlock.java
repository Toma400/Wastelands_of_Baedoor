...
public class ChiseledBYGEbonyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_ebony_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGEbonyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 531);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_ebony_wooden_slab");
		}
