...
public class ChiseledBYGEbonyWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_ebony_wood")
	public static final Block block = null;
	public ChiseledBYGEbonyWoodBlock(WobrModElements instance) {
		super(instance, 528);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_ebony_wood");
		}
