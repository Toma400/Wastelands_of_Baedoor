...
public class StrippedNutwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_nutwood_wooden_slab")
	public static final Block block = null;
	public StrippedNutwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 522);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_nutwood_wooden_slab");
		}
