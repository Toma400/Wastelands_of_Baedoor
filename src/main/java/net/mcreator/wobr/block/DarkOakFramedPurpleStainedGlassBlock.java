...
public class DarkOakFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_purple_stained_glass")
	public static final Block block = null;
	public DarkOakFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 362);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_purple_stained_glass");
		}
