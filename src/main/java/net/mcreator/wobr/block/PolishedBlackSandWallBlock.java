...
public class PolishedBlackSandWallBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:polished_black_sand_wall")
	public static final Block block = null;
	public PolishedBlackSandWallBlock(WobrModElements instance) {
		super(instance, 82);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("polished_black_sand_wall");
		}
