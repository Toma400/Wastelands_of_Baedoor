...
public class AcaciaFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_blue_stained_glass")
	public static final Block block = null;
	public AcaciaFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 287);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_blue_stained_glass");
		}
