...
public class SandyBirchFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_gray_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 411);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_gray_stained_glass");
		}
