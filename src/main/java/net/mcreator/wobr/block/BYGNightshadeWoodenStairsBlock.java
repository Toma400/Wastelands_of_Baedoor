...
public class BYGNightshadeWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_nightshade_wooden_stairs")
	public static final Block block = null;
	public BYGNightshadeWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1897);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_nightshade_wooden_stairs");
		}
