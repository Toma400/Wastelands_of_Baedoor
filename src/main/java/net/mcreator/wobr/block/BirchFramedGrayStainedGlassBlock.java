...
public class BirchFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_gray_stained_glass")
	public static final Block block = null;
	public BirchFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_gray_stained_glass");
		}
