...
public class StrippedBYGEbonyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_ebony_wooden_slab")
	public static final Block block = null;
	public StrippedBYGEbonyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_ebony_wooden_slab");
		}
