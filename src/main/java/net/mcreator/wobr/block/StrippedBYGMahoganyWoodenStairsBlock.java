...
public class StrippedBYGMahoganyWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_mahogany_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGMahoganyWoodenStairsBlock(WobrModElements instance) {
		super(instance, 582);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_mahogany_wooden_stairs");
		}
