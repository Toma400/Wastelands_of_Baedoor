...
public class BYGEtherWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_ether_wooden_slab")
	public static final Block block = null;
	public BYGEtherWoodenSlabBlock(WobrModElements instance) {
		super(instance, 538);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_ether_wooden_slab");
		}
