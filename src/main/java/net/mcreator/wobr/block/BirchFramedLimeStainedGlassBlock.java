...
public class BirchFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_lime_stained_glass")
	public static final Block block = null;
	public BirchFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 322);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_lime_stained_glass");
		}
