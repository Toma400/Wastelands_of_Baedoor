...
public class WarpedFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_cyan_stained_glass")
	public static final Block block = null;
	public WarpedFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 445);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_cyan_stained_glass");
		}
