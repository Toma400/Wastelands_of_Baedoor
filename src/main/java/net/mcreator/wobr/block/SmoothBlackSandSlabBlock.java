...
public class SmoothBlackSandSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:smooth_black_sand_slab")
	public static final Block block = null;
	public SmoothBlackSandSlabBlock(WobrModElements instance) {
		super(instance, 86);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("smooth_black_sand_slab");
		}
