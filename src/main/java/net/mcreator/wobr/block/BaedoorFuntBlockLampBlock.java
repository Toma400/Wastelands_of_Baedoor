...
public class BaedoorFuntBlockLampBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:baedoor_funt_block_lamp")
	public static final Block block = null;
	public BaedoorFuntBlockLampBlock(WobrModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(6f, 6f).lightValue(15).harvestLevel(1)
					.harvestTool(ToolType.PICKAXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("baedoor_funt_block_lamp");
		}
