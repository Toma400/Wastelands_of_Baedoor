...
public class BYGEbonyWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_ebony_wooden_stairs")
	public static final Block block = null;
	public BYGEbonyWoodenStairsBlock(WobrModElements instance) {
		super(instance, 531);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_ebony_wooden_stairs");
		}
