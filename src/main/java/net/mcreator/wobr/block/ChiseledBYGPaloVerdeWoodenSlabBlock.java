...
public class ChiseledBYGPaloVerdeWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_palo_verde_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGPaloVerdeWoodenSlabBlock(WobrModElements instance) {
		super(instance, 620);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_palo_verde_wooden_slab");
		}
