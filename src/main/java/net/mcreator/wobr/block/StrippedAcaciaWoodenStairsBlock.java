...
public class StrippedAcaciaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_acacia_wooden_stairs")
	public static final Block block = null;
	public StrippedAcaciaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_acacia_wooden_stairs");
		}
