...
public class ChiseledBlueNetherBrickBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_blue_nether_brick")
	public static final Block block = null;
	public ChiseledBlueNetherBrickBlock(WobrModElements instance) {
		super(instance, 217);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_blue_nether_brick");
		}
