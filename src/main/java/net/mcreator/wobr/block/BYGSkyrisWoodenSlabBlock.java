...
public class BYGSkyrisWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_skyris_wooden_slab")
	public static final Block block = null;
	public BYGSkyrisWoodenSlabBlock(WobrModElements instance) {
		super(instance, 634);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_skyris_wooden_slab");
		}
