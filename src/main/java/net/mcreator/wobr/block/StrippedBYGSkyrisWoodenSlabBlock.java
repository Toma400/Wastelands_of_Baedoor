...
public class StrippedBYGSkyrisWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_skyris_wooden_slab")
	public static final Block block = null;
	public StrippedBYGSkyrisWoodenSlabBlock(WobrModElements instance) {
		super(instance, 638);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_skyris_wooden_slab");
		}
