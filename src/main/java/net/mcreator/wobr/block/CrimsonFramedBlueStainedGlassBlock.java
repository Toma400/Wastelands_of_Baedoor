...
public class CrimsonFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_blue_stained_glass")
	public static final Block block = null;
	public CrimsonFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_blue_stained_glass");
		}
