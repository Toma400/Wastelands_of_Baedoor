...
public class SandyBirchFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_red_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 400);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_red_stained_glass");
		}
