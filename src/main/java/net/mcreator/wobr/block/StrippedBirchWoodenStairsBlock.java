...
public class StrippedBirchWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_birch_wooden_stairs")
	public static final Block block = null;
	public StrippedBirchWoodenStairsBlock(WobrModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_birch_wooden_stairs");
		}
