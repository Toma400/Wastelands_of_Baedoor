...
public class StrippedBYGNightshadeWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_nightshade_wooden_slab")
	public static final Block block = null;
	public StrippedBYGNightshadeWoodenSlabBlock(WobrModElements instance) {
		super(instance, 606);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_nightshade_wooden_slab");
		}
