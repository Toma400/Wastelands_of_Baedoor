...
public class JungleFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_orange_stained_glass")
	public static final Block block = null;
	public JungleFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 372);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_orange_stained_glass");
		}
