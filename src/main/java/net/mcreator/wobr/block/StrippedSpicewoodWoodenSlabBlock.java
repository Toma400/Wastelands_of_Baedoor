...
public class StrippedSpicewoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_spicewood_wooden_slab")
	public static final Block block = null;
	public StrippedSpicewoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 568);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_spicewood_wooden_slab");
		}
