...
public class ChiseledDarkwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_darkwood_wooden_slab")
	public static final Block block = null;
	public ChiseledDarkwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 569);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_darkwood_wooden_slab");
		}
