...
public class JungleFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_light_gray_stained_glass")
	public static final Block block = null;
	public JungleFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 369);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_light_gray_stained_glass");
		}
