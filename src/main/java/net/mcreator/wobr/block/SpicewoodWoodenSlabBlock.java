...
public class SpicewoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spicewood_wooden_slab")
	public static final Block block = null;
	public SpicewoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 526);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("spicewood_wooden_slab");
		}
