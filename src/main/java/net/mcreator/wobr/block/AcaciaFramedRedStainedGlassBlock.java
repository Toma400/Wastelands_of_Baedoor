...
public class AcaciaFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_red_stained_glass")
	public static final Block block = null;
	public AcaciaFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 295);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_red_stained_glass");
		}
