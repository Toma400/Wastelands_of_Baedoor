...
public class GrayHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:gray_horizontal_stained_glass_pane")
	public static final Block block = null;
	public GrayHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 280);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("gray_horizontal_stained_glass_pane");
		}
