...
public class ChiseledBYGSkyrisWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_skyris_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGSkyrisWoodenSlabBlock(WobrModElements instance) {
		super(instance, 636);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_skyris_wooden_slab");
		}
