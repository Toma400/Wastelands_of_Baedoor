...
public class DarkOakFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_magenta_stained_glass")
	public static final Block block = null;
	public DarkOakFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_magenta_stained_glass");
		}
