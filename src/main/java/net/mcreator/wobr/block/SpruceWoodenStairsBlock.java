...
public class SpruceWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_wooden_stairs")
	public static final Block block = null;
	public SpruceWoodenStairsBlock(WobrModElements instance) {
		super(instance, 125);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_wooden_stairs");
		}
