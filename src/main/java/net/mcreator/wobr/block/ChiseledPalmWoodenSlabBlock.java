...
public class ChiseledPalmWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_palm_wooden_slab")
	public static final Block block = null;
	public ChiseledPalmWoodenSlabBlock(WobrModElements instance) {
		super(instance, 474);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_palm_wooden_slab");
		}
