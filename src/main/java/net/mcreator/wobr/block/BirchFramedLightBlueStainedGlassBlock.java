...
public class BirchFramedLightBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_light_blue_stained_glass")
	public static final Block block = null;
	public BirchFramedLightBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 325);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_light_blue_stained_glass");
		}
