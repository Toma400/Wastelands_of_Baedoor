...
public class AcaciaFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_green_stained_glass")
	public static final Block block = null;
	public AcaciaFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 287);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_green_stained_glass");
		}
