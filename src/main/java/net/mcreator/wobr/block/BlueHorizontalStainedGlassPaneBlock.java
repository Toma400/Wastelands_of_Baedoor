...
public class BlueHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:blue_horizontal_stained_glass_pane")
	public static final Block block = null;
	public BlueHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 271);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_horizontal_stained_glass_pane");
		}
