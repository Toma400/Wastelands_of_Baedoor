...
public class BlueShroomedWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:blue_shroomed_wooden_stairs")
	public static final Block block = null;
	public BlueShroomedWoodenStairsBlock(WobrModElements instance) {
		super(instance, 509);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blue_shroomed_wooden_stairs");
		}
