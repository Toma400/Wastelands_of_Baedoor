...
public class PillarBirchBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:pillar_birch")
	public static final Block block = null;
	public PillarBirchBlock(WobrModElements instance) {
		super(instance, 157);
	}
