...
public class ChiseledStrippedBYGCikaWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_byg_cika_wood")
	public static final Block block = null;
	public ChiseledStrippedBYGCikaWoodBlock(WobrModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_byg_cika_wood");
		}
