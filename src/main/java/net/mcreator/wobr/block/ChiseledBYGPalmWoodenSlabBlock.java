...
public class ChiseledBYGPalmWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_palm_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGPalmWoodenSlabBlock(WobrModElements instance) {
		super(instance, 612);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_palm_wooden_slab");
		}
