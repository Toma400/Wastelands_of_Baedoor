...
public class StrippedDarkwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_darkwood_wooden_slab")
	public static final Block block = null;
	public StrippedDarkwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 710);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_darkwood_wooden_slab");
		}
