...
public class BYGEbonyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_ebony_wooden_slab")
	public static final Block block = null;
	public BYGEbonyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 512);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_ebony_wooden_slab");
		}
