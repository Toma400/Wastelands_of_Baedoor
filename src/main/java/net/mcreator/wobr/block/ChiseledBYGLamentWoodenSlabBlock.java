...
public class ChiseledBYGLamentWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_lament_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGLamentWoodenSlabBlock(WobrModElements instance) {
		super(instance, 571);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_lament_wooden_slab");
		}
