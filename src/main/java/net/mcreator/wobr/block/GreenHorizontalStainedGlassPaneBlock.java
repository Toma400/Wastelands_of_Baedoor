...
public class GreenHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:green_horizontal_stained_glass_pane")
	public static final Block block = null;
	public GreenHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("green_horizontal_stained_glass_pane");
		}
