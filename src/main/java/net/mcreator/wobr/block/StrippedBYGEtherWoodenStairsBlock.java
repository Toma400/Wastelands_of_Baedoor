...
public class StrippedBYGEtherWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_ether_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGEtherWoodenStairsBlock(WobrModElements instance) {
		super(instance, 525);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_ether_wooden_stairs");
		}
