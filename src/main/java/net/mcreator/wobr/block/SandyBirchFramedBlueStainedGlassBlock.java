...
public class SandyBirchFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_blue_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 415);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_blue_stained_glass");
		}
