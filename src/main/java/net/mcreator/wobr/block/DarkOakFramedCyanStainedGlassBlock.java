...
public class DarkOakFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_cyan_stained_glass")
	public static final Block block = null;
	public DarkOakFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 349);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_cyan_stained_glass");
		}
