...
public class DarkOakFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_gray_stained_glass")
	public static final Block block = null;
	public DarkOakFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 347);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_gray_stained_glass");
		}
