...
public class ChiseledBYGNightshadeWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_nightshade_wood")
	public static final Block block = null;
	public ChiseledBYGNightshadeWoodBlock(WobrModElements instance) {
		super(instance, 601);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_nightshade_wood");
		}
