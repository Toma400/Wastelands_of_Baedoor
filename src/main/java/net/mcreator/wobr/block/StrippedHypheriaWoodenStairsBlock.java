...
public class StrippedHypheriaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_hypheria_wooden_stairs")
	public static final Block block = null;
	public StrippedHypheriaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 555);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_hypheria_wooden_stairs");
		}
