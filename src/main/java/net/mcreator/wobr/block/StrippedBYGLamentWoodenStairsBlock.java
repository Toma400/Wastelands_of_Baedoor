...
public class StrippedBYGLamentWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_lament_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGLamentWoodenStairsBlock(WobrModElements instance) {
		super(instance, 575);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_lament_wooden_stairs");
		}
