...
public class StrippedBYGEtherWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_ether_wooden_slab")
	public static final Block block = null;
	public StrippedBYGEtherWoodenSlabBlock(WobrModElements instance) {
		super(instance, 541);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_ether_wooden_slab");
		}
