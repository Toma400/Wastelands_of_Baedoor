...
public class StrippedOakWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_oak_wooden_stairs")
	public static final Block block = null;
	public StrippedOakWoodenStairsBlock(WobrModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_oak_wooden_stairs");
		}
