...
public class AshaHypheriaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:asha_hypheria_wooden_stairs")
	public static final Block block = null;
	public AshaHypheriaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 687);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("asha_hypheria_wooden_stairs");
		}
