...
public class CutOrangeShroomedWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cut_orange_shroomed_wood")
	public static final Block block = null;
	public CutOrangeShroomedWoodBlock(WobrModElements instance) {
		super(instance, 545);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_orange_shroomed_wood");
		}
