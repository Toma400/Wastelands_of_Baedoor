...
public class BirchFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_purple_stained_glass")
	public static final Block block = null;
	public BirchFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 331);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_purple_stained_glass");
		}
