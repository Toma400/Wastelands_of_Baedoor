...
public class ChiseledBYGPineWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_pine_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGPineWoodenSlabBlock(WobrModElements instance) {
		super(instance, 2206);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_pine_wooden_slab");
		}
