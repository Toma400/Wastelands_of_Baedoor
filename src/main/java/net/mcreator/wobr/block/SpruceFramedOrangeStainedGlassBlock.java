...
public class SpruceFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_orange_stained_glass")
	public static final Block block = null;
	public SpruceFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 441);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_orange_stained_glass");
		}
