...
public class ChiseledBYGCherryWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_cherry_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGCherryWoodenSlabBlock(WobrModElements instance) {
		super(instance, 508);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_cherry_wooden_slab");
		}
