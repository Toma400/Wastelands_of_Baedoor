...
public class WarpedFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_brown_stained_glass")
	public static final Block block = null;
	public WarpedFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 441);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_brown_stained_glass");
		}
