...
public class StrippedBYGCikaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_cika_wooden_slab")
	public static final Block block = null;
	public StrippedBYGCikaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 517);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_cika_wooden_slab");
		}
