...
public class BlockofMushroomPoisonBlock extends WobrModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0.1f, 0.1f).lightValue(0));
			setRegistryName("blockof_mushroom_poison");
		}
