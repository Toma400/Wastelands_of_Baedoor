...
public class BYGNightshadeWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_nightshade_wooden_slab")
	public static final Block block = null;
	public BYGNightshadeWoodenSlabBlock(WobrModElements instance) {
		super(instance, 602);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_nightshade_wooden_slab");
		}
