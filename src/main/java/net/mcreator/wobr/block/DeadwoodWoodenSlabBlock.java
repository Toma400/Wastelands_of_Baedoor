...
public class DeadwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:deadwood_wooden_slab")
	public static final Block block = null;
	public DeadwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 487);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("deadwood_wooden_slab");
		}
