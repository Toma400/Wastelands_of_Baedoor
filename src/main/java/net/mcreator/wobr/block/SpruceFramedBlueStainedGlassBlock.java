...
public class SpruceFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_blue_stained_glass")
	public static final Block block = null;
	public SpruceFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 404);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_blue_stained_glass");
		}
