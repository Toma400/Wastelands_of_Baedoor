...
public class JungleFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_green_stained_glass")
	public static final Block block = null;
	public JungleFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 371);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_green_stained_glass");
		}
