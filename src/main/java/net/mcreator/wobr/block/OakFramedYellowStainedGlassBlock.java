...
public class OakFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_yellow_stained_glass")
	public static final Block block = null;
	public OakFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 398);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_yellow_stained_glass");
		}
