...
public class OakFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_lime_stained_glass")
	public static final Block block = null;
	public OakFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 386);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_lime_stained_glass");
		}
