...
public class PinkHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:pink_horizontal_stained_glass_pane")
	public static final Block block = null;
	public PinkHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 276);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("pink_horizontal_stained_glass_pane");
		}
