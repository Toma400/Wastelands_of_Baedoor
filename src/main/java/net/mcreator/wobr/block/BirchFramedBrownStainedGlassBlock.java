...
public class BirchFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_brown_stained_glass")
	public static final Block block = null;
	public BirchFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_brown_stained_glass");
		}
