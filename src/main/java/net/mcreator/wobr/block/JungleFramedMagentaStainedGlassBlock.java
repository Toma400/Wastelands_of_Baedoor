...
public class JungleFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_magenta_stained_glass")
	public static final Block block = null;
	public JungleFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 375);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_magenta_stained_glass");
		}
