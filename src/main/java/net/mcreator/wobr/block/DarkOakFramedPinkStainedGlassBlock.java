...
public class DarkOakFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_pink_stained_glass")
	public static final Block block = null;
	public DarkOakFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 357);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_pink_stained_glass");
		}
