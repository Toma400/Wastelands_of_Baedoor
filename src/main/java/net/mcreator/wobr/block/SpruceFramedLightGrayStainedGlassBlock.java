...
public class SpruceFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_light_gray_stained_glass")
	public static final Block block = null;
	public SpruceFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 433);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_light_gray_stained_glass");
		}
