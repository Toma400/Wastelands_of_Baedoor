...
public class StrippedBYGFirWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_fir_wooden_slab")
	public static final Block block = null;
	public StrippedBYGFirWoodenSlabBlock(WobrModElements instance) {
		super(instance, 550);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_fir_wooden_slab");
		}
