...
public class CrimsonFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_gray_stained_glass")
	public static final Block block = null;
	public CrimsonFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 334);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_gray_stained_glass");
		}
