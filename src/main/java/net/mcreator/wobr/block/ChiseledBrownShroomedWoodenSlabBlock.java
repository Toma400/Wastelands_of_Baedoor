...
public class ChiseledBrownShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_brown_shroomed_wooden_slab")
	public static final Block block = null;
	public ChiseledBrownShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 645);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_brown_shroomed_wooden_slab");
		}
