...
public class JungleFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_purple_stained_glass")
	public static final Block block = null;
	public JungleFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 351);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_purple_stained_glass");
		}
