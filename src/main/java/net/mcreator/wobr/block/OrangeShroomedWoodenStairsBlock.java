...
public class OrangeShroomedWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:orange_shroomed_wooden_stairs")
	public static final Block block = null;
	public OrangeShroomedWoodenStairsBlock(WobrModElements instance) {
		super(instance, 605);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_shroomed_wooden_stairs");
		}
