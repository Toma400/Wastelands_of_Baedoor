...
public class BirchFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_green_stained_glass")
	public static final Block block = null;
	public BirchFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 319);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_green_stained_glass");
		}
