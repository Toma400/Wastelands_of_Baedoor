...
public class RedAcaciaFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_gray_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 398);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_gray_stained_glass");
		}
