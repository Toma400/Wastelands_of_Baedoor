...
public class StrippedHypheriaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_hypheria_wooden_slab")
	public static final Block block = null;
	public StrippedHypheriaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 554);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_hypheria_wooden_slab");
		}
