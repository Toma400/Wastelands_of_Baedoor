...
public class BYGCikaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_cika_wooden_stairs")
	public static final Block block = null;
	public BYGCikaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 515);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_cika_wooden_stairs");
		}
