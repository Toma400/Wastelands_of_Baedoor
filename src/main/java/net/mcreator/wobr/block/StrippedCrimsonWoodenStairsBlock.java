...
public class StrippedCrimsonWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_crimson_wooden_stairs")
	public static final Block block = null;
	public StrippedCrimsonWoodenStairsBlock(WobrModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_crimson_wooden_stairs");
		}
