...
public class BYGFirWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_fir_wooden_stairs")
	public static final Block block = null;
	public BYGFirWoodenStairsBlock(WobrModElements instance) {
		super(instance, 547);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_fir_wooden_stairs");
		}
