...
public class StrippedBYGMangroveWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_mangrove_wooden_slab")
	public static final Block block = null;
	public StrippedBYGMangroveWoodenSlabBlock(WobrModElements instance) {
		super(instance, 589);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_mangrove_wooden_slab");
		}
