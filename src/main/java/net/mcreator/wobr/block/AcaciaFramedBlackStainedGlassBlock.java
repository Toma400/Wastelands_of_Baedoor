...
public class AcaciaFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_black_stained_glass")
	public static final Block block = null;
	public AcaciaFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 282);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_black_stained_glass");
		}
