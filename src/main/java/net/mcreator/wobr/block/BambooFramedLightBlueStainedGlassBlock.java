...
public class BambooFramedLightBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_light_blue_stained_glass")
	public static final Block block = null;
	public BambooFramedLightBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 309);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_light_blue_stained_glass");
		}
