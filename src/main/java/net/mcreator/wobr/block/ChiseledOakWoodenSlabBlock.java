...
public class ChiseledOakWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_oak_wooden_slab")
	public static final Block block = null;
	public ChiseledOakWoodenSlabBlock(WobrModElements instance) {
		super(instance, 95);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_oak_wooden_slab");
		}
