...
public class BirchFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_yellow_stained_glass")
	public static final Block block = null;
	public BirchFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 329);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_yellow_stained_glass");
		}
