...
public class StrippedDarkOakWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_dark_oak_wooden_slab")
	public static final Block block = null;
	public StrippedDarkOakWoodenSlabBlock(WobrModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_dark_oak_wooden_slab");
		}
