...
public class SpruceFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_white_stained_glass")
	public static final Block block = null;
	public SpruceFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 444);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_white_stained_glass");
		}
