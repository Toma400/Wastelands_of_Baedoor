...
public class YellowHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:yellow_horizontal_stained_glass_pane")
	public static final Block block = null;
	public YellowHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 283);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("yellow_horizontal_stained_glass_pane");
		}
