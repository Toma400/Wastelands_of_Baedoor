...
public class SpruceFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_yellow_stained_glass")
	public static final Block block = null;
	public SpruceFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 438);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_yellow_stained_glass");
		}
