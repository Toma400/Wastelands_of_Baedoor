...
public class StrippedDeadwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_deadwood_wooden_stairs")
	public static final Block block = null;
	public StrippedDeadwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 491);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_deadwood_wooden_stairs");
		}
