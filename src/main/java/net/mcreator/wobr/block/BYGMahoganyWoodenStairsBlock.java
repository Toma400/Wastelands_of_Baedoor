...
public class BYGMahoganyWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_mahogany_wooden_stairs")
	public static final Block block = null;
	public BYGMahoganyWoodenStairsBlock(WobrModElements instance) {
		super(instance, 579);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_mahogany_wooden_stairs");
		}
