...
public class SpruceFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_magenta_stained_glass")
	public static final Block block = null;
	public SpruceFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 440);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_magenta_stained_glass");
		}
