...
public class JungleFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_blue_stained_glass")
	public static final Block block = null;
	public JungleFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 363);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_blue_stained_glass");
		}
