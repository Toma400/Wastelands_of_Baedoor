...
public class StrippedBYGMapleWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_maple_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGMapleWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1892);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_maple_wooden_stairs");
		}
