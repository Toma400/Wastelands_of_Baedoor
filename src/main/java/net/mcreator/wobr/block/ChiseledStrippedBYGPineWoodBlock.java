...
public class ChiseledStrippedBYGPineWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_byg_pine_wood")
	public static final Block block = null;
	public ChiseledStrippedBYGPineWoodBlock(WobrModElements instance) {
		super(instance, 2210);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_byg_pine_wood");
		}
