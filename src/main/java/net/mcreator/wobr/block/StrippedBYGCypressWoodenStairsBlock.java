...
public class StrippedBYGCypressWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_cypress_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGCypressWoodenStairsBlock(WobrModElements instance) {
		super(instance, 527);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_cypress_wooden_stairs");
		}
