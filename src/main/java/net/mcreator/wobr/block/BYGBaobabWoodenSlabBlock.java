...
public class BYGBaobabWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_baobab_wooden_slab")
	public static final Block block = null;
	public BYGBaobabWoodenSlabBlock(WobrModElements instance) {
		super(instance, 497);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_baobab_wooden_slab");
		}
