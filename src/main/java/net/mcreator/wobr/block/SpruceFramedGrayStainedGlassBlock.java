...
public class SpruceFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_gray_stained_glass")
	public static final Block block = null;
	public SpruceFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 434);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_gray_stained_glass");
		}
