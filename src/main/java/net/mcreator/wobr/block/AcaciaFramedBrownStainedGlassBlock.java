...
public class AcaciaFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_brown_stained_glass")
	public static final Block block = null;
	public AcaciaFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 289);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_brown_stained_glass");
		}
