...
public class WarpedFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_lime_stained_glass")
	public static final Block block = null;
	public WarpedFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 427);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_lime_stained_glass");
		}
