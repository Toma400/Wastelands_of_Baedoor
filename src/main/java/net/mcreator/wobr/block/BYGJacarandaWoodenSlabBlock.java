...
public class BYGJacarandaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_jacaranda_wooden_slab")
	public static final Block block = null;
	public BYGJacarandaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 562);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_jacaranda_wooden_slab");
		}
