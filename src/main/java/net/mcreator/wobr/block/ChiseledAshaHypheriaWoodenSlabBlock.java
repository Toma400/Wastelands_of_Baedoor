...
public class ChiseledAshaHypheriaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_asha_hypheria_wooden_slab")
	public static final Block block = null;
	public ChiseledAshaHypheriaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 548);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_asha_hypheria_wooden_slab");
		}
