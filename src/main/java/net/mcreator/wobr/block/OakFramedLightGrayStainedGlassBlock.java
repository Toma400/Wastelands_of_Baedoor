...
public class OakFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_light_gray_stained_glass")
	public static final Block block = null;
	public OakFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 382);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_light_gray_stained_glass");
		}
