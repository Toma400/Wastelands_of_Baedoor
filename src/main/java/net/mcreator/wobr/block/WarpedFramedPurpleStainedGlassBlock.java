...
public class WarpedFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_purple_stained_glass")
	public static final Block block = null;
	public WarpedFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 459);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_purple_stained_glass");
		}
