...
public class StrippedBYGMahoganyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_mahogany_wooden_slab")
	public static final Block block = null;
	public StrippedBYGMahoganyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 581);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_mahogany_wooden_slab");
		}
