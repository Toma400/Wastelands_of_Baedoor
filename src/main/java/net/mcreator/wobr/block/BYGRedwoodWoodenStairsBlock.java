...
public class BYGRedwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_redwood_wooden_stairs")
	public static final Block block = null;
	public BYGRedwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 627);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_redwood_wooden_stairs");
		}
