...
public class WarpedFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_green_stained_glass")
	public static final Block block = null;
	public WarpedFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 447);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_green_stained_glass");
		}
