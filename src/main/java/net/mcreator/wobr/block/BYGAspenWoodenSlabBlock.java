...
public class BYGAspenWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_aspen_wooden_slab")
	public static final Block block = null;
	public BYGAspenWoodenSlabBlock(WobrModElements instance) {
		super(instance, 2193);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_aspen_wooden_slab");
		}
