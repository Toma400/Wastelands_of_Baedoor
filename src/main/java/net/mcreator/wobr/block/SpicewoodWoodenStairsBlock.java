...
public class SpicewoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spicewood_wooden_stairs")
	public static final Block block = null;
	public SpicewoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 671);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("spicewood_wooden_stairs");
		}
