...
public class ChiseledStrippedDeadwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_deadwood_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedDeadwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 487);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_deadwood_wooden_slab");
		}
