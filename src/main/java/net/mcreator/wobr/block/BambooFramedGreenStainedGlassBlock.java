...
public class BambooFramedGreenStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_green_stained_glass")
	public static final Block block = null;
	public BambooFramedGreenStainedGlassBlock(WobrModElements instance) {
		super(instance, 280);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_green_stained_glass");
		}
