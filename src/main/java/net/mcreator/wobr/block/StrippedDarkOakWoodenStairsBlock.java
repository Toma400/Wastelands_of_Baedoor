...
public class StrippedDarkOakWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_dark_oak_wooden_stairs")
	public static final Block block = null;
	public StrippedDarkOakWoodenStairsBlock(WobrModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_dark_oak_wooden_stairs");
		}
