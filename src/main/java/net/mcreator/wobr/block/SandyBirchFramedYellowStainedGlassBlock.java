...
public class SandyBirchFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_yellow_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 402);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_yellow_stained_glass");
		}
