...
public class StrippedDeadwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_deadwood_wooden_slab")
	public static final Block block = null;
	public StrippedDeadwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 485);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_deadwood_wooden_slab");
		}
