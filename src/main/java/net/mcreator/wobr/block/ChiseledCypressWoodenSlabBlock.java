...
public class ChiseledCypressWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_cypress_wooden_slab")
	public static final Block block = null;
	public ChiseledCypressWoodenSlabBlock(WobrModElements instance) {
		super(instance, 574);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_cypress_wooden_slab");
		}
