...
public class ChiseledBYGRedwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_redwood_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGRedwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 1929);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_redwood_wooden_slab");
		}
