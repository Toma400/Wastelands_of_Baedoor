...
public class StrippedBYGAspenWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_aspen_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGAspenWoodenStairsBlock(WobrModElements instance) {
		super(instance, 2199);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_aspen_wooden_stairs");
		}
