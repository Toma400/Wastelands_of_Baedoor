...
public class CrimsonFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_cyan_stained_glass")
	public static final Block block = null;
	public CrimsonFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 333);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_cyan_stained_glass");
		}
