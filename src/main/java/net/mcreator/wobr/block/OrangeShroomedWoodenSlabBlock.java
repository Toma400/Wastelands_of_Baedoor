...
public class OrangeShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:orange_shroomed_wooden_slab")
	public static final Block block = null;
	public OrangeShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 547);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_shroomed_wooden_slab");
		}
