...
public class SandyBirchFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_white_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 428);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_white_stained_glass");
		}
