...
public class BambooFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_cyan_stained_glass")
	public static final Block block = null;
	public BambooFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 301);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_cyan_stained_glass");
		}
