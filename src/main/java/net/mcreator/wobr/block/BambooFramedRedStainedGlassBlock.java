...
public class BambooFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_red_stained_glass")
	public static final Block block = null;
	public BambooFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 316);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_red_stained_glass");
		}
