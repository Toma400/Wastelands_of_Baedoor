...
public class ChiseledSpicewoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_spicewood_wooden_slab")
	public static final Block block = null;
	public ChiseledSpicewoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 533);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_spicewood_wooden_slab");
		}
