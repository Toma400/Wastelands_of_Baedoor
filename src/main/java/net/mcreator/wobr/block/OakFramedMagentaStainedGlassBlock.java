...
public class OakFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_magenta_stained_glass")
	public static final Block block = null;
	public OakFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 392);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_magenta_stained_glass");
		}
