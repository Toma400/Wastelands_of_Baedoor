...
public class BambooFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_brown_stained_glass")
	public static final Block block = null;
	public BambooFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_brown_stained_glass");
		}
