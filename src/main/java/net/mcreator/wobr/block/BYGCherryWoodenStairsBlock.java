...
public class BYGCherryWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_cherry_wooden_stairs")
	public static final Block block = null;
	public BYGCherryWoodenStairsBlock(WobrModElements instance) {
		super(instance, 507);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_cherry_wooden_stairs");
		}
