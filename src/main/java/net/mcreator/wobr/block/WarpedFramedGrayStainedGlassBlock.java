...
public class WarpedFramedGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_gray_stained_glass")
	public static final Block block = null;
	public WarpedFramedGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 451);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_gray_stained_glass");
		}
