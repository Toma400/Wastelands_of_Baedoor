...
public class StrippedBYGHollyWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_holly_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGHollyWoodenStairsBlock(WobrModElements instance) {
		super(instance, 559);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_holly_wooden_stairs");
		}
