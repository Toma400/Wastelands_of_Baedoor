...
public class StrippedCypressWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_cypress_wooden_slab")
	public static final Block block = null;
	public StrippedCypressWoodenSlabBlock(WobrModElements instance) {
		super(instance, 542);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_cypress_wooden_slab");
		}
