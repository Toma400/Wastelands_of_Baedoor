...
public class BambooFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_purple_stained_glass")
	public static final Block block = null;
	public BambooFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 307);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_purple_stained_glass");
		}
