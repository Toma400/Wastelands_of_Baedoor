...
public class ChiseledSpruceWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_spruce_wooden_slab")
	public static final Block block = null;
	public ChiseledSpruceWoodenSlabBlock(WobrModElements instance) {
		super(instance, 129);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_spruce_wooden_slab");
		}
