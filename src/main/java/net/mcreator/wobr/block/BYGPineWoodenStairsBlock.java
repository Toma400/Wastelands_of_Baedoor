...
public class BYGPineWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_pine_wooden_stairs")
	public static final Block block = null;
	public BYGPineWoodenStairsBlock(WobrModElements instance) {
		super(instance, 2204);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_pine_wooden_stairs");
		}
