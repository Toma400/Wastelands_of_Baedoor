...
public class AcaciaFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_purple_stained_glass")
	public static final Block block = null;
	public AcaciaFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 294);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_purple_stained_glass");
		}
