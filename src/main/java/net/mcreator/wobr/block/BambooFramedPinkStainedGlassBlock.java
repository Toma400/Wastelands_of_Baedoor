...
public class BambooFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_pink_stained_glass")
	public static final Block block = null;
	public BambooFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 314);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_pink_stained_glass");
		}
