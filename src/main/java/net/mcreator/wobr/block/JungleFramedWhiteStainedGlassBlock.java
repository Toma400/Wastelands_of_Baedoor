...
public class JungleFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_white_stained_glass")
	public static final Block block = null;
	public JungleFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 381);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_white_stained_glass");
		}
