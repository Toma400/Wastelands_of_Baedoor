...
public class BirchFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_white_stained_glass")
	public static final Block block = null;
	public BirchFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_white_stained_glass");
		}
