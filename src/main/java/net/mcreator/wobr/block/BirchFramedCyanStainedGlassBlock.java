...
public class BirchFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_cyan_stained_glass")
	public static final Block block = null;
	public BirchFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 317);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_cyan_stained_glass");
		}
