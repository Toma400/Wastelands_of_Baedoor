...
public class StrippedBYGPineWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_pine_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGPineWoodenStairsBlock(WobrModElements instance) {
		super(instance, 2209);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_pine_wooden_stairs");
		}
