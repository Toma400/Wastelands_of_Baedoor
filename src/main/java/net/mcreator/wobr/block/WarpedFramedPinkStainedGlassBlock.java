...
public class WarpedFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_pink_stained_glass")
	public static final Block block = null;
	public WarpedFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 453);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_pink_stained_glass");
		}
