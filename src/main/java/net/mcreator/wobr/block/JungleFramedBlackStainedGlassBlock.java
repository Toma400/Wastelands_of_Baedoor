...
public class JungleFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_black_stained_glass")
	public static final Block block = null;
	public JungleFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 362);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_black_stained_glass");
		}
