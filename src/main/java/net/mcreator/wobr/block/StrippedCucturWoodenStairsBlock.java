...
public class StrippedCucturWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_cuctur_wooden_stairs")
	public static final Block block = null;
	public StrippedCucturWoodenStairsBlock(WobrModElements instance) {
		super(instance, 703);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_cuctur_wooden_stairs");
		}
