...
public class JungleWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_wooden_stairs")
	public static final Block block = null;
	public JungleWoodenStairsBlock(WobrModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_wooden_stairs");
		}
