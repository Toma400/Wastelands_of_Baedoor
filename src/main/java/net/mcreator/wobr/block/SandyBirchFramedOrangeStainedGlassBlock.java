...
public class SandyBirchFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_orange_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 425);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_orange_stained_glass");
		}
