...
public class BambooFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_lime_stained_glass")
	public static final Block block = null;
	public BambooFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 306);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_lime_stained_glass");
		}
