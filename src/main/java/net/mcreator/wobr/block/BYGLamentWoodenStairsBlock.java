...
public class BYGLamentWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_lament_wooden_stairs")
	public static final Block block = null;
	public BYGLamentWoodenStairsBlock(WobrModElements instance) {
		super(instance, 571);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_lament_wooden_stairs");
		}
