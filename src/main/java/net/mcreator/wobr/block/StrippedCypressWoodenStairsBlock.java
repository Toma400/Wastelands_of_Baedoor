...
public class StrippedCypressWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_cypress_wooden_stairs")
	public static final Block block = null;
	public StrippedCypressWoodenStairsBlock(WobrModElements instance) {
		super(instance, 544);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_cypress_wooden_stairs");
		}
