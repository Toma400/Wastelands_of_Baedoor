...
public class ChiseledStrippedCypressWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_cypress_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedCypressWoodenSlabBlock(WobrModElements instance) {
		super(instance, 545);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_cypress_wooden_slab");
		}
