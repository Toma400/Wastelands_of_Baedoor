...
public class OakFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_purple_stained_glass")
	public static final Block block = null;
	public OakFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 390);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_purple_stained_glass");
		}
