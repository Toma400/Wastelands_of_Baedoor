...
public class ChiseledRedNetherBrickBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_red_nether_brick")
	public static final Block block = null;
	public ChiseledRedNetherBrickBlock(WobrModElements instance) {
		super(instance, 212);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseled_red_nether_brick");
		}
