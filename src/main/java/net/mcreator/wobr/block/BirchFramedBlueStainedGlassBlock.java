...
public class BirchFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_blue_stained_glass")
	public static final Block block = null;
	public BirchFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 315);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_blue_stained_glass");
		}
