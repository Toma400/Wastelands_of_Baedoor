...
public class ChiseledDeadwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_deadwood_wooden_slab")
	public static final Block block = null;
	public ChiseledDeadwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 483);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_deadwood_wooden_slab");
		}
