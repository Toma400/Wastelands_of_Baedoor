...
public class HypheriaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:hypheria_wooden_slab")
	public static final Block block = null;
	public HypheriaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 641);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("hypheria_wooden_slab");
		}
