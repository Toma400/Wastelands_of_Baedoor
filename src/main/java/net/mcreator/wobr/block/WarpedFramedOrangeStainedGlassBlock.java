...
public class WarpedFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_orange_stained_glass")
	public static final Block block = null;
	public WarpedFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 457);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_orange_stained_glass");
		}
