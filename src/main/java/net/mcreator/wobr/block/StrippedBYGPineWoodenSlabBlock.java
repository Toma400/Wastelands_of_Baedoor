...
public class StrippedBYGPineWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_pine_wooden_slab")
	public static final Block block = null;
	public StrippedBYGPineWoodenSlabBlock(WobrModElements instance) {
		super(instance, 2208);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_pine_wooden_slab");
		}
