...
public class BambooFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bamboo_framed_yellow_stained_glass")
	public static final Block block = null;
	public BambooFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 318);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("bamboo_framed_yellow_stained_glass");
		}
