...
public class AcaciaFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_magenta_stained_glass")
	public static final Block block = null;
	public AcaciaFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_magenta_stained_glass");
		}
