...
public class DarkOakFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_blue_stained_glass")
	public static final Block block = null;
	public DarkOakFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 347);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_blue_stained_glass");
		}
