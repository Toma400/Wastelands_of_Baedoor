...
public class ChiseledBYGJacarandaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_jacaranda_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGJacarandaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 563);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_jacaranda_wooden_slab");
		}
