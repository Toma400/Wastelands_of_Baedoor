...
public class SpruceFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_cyan_stained_glass")
	public static final Block block = null;
	public SpruceFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 429);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_cyan_stained_glass");
		}
