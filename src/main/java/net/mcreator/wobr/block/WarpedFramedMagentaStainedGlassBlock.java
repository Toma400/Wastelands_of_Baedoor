...
public class WarpedFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_magenta_stained_glass")
	public static final Block block = null;
	public WarpedFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 448);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_magenta_stained_glass");
		}
