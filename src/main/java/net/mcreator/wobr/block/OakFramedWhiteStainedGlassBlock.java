...
public class OakFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_white_stained_glass")
	public static final Block block = null;
	public OakFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 392);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_white_stained_glass");
		}
