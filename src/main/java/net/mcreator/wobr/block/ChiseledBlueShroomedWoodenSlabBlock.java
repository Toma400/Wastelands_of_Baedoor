...
public class ChiseledBlueShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_blue_shroomed_wooden_slab")
	public static final Block block = null;
	public ChiseledBlueShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 544);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_blue_shroomed_wooden_slab");
		}
