...
public class WarpedFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_light_gray_stained_glass")
	public static final Block block = null;
	public WarpedFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 449);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_light_gray_stained_glass");
		}
