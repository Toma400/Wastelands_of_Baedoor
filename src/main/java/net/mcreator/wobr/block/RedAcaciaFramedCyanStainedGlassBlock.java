...
public class RedAcaciaFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_cyan_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 397);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_cyan_stained_glass");
		}
