...
public class StrippedWarpedWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_warped_wooden_stairs")
	public static final Block block = null;
	public StrippedWarpedWoodenStairsBlock(WobrModElements instance) {
		super(instance, 154);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_warped_wooden_stairs");
		}
