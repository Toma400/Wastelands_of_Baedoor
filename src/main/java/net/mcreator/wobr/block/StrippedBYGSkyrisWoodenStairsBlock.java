...
public class StrippedBYGSkyrisWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_skyris_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGSkyrisWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1942);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_skyris_wooden_stairs");
		}
