...
public class ChiseledBirchWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_birch_wooden_slab")
	public static final Block block = null;
	public ChiseledBirchWoodenSlabBlock(WobrModElements instance) {
		super(instance, 110);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_birch_wooden_slab");
		}
