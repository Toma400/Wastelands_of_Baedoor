...
public class SpruceFramedPinkStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_pink_stained_glass")
	public static final Block block = null;
	public SpruceFramedPinkStainedGlassBlock(WobrModElements instance) {
		super(instance, 442);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_pink_stained_glass");
		}
