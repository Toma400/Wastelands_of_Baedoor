...
public class ChiseledNutwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_nutwood_wooden_slab")
	public static final Block block = null;
	public ChiseledNutwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 558);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_nutwood_wooden_slab");
		}
