...
public class DarkOakWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_wooden_stairs")
	public static final Block block = null;
	public DarkOakWoodenStairsBlock(WobrModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_wooden_stairs");
		}
