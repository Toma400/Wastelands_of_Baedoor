...
public class BYGCherryWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_cherry_wooden_slab")
	public static final Block block = null;
	public BYGCherryWoodenSlabBlock(WobrModElements instance) {
		super(instance, 506);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_cherry_wooden_slab");
		}
