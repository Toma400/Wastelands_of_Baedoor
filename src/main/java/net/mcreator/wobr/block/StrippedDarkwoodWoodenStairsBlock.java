...
public class StrippedDarkwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_darkwood_wooden_stairs")
	public static final Block block = null;
	public StrippedDarkwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 711);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_darkwood_wooden_stairs");
		}
