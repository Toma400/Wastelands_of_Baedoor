...
public class ChiseledJungleWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_jungle_wood")
	public static final Block block = null;
	public ChiseledJungleWoodBlock(WobrModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_jungle_wood");
		}
