...
public class OrangeHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:orange_horizontal_stained_glass_pane")
	public static final Block block = null;
	public OrangeHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 278);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_horizontal_stained_glass_pane");
		}
