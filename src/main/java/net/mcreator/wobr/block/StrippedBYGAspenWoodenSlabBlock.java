...
public class StrippedBYGAspenWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_aspen_wooden_slab")
	public static final Block block = null;
	public StrippedBYGAspenWoodenSlabBlock(WobrModElements instance) {
		super(instance, 2198);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_aspen_wooden_slab");
		}
