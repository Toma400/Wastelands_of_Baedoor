...
public class StrippedBYGCherryWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_cherry_wooden_slab")
	public static final Block block = null;
	public StrippedBYGCherryWoodenSlabBlock(WobrModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_cherry_wooden_slab");
		}
