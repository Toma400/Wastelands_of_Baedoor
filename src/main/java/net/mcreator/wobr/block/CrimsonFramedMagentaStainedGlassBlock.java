...
public class CrimsonFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_magenta_stained_glass")
	public static final Block block = null;
	public CrimsonFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 339);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_magenta_stained_glass");
		}
