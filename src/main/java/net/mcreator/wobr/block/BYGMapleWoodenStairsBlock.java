...
public class BYGMapleWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_maple_wooden_stairs")
	public static final Block block = null;
	public BYGMapleWoodenStairsBlock(WobrModElements instance) {
		super(instance, 595);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_maple_wooden_stairs");
		}
