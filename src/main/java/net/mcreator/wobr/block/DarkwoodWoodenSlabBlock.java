...
public class DarkwoodWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:darkwood_wooden_slab")
	public static final Block block = null;
	public DarkwoodWoodenSlabBlock(WobrModElements instance) {
		super(instance, 566);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("darkwood_wooden_slab");
		}
