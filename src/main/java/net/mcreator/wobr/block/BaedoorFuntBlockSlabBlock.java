...
public class BaedoorFuntBlockSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:baedoor_funt_block_slab")
	public static final Block block = null;
	public BaedoorFuntBlockSlabBlock(WobrModElements instance) {
		super(instance, 189);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("baedoor_funt_block_slab");
		}
