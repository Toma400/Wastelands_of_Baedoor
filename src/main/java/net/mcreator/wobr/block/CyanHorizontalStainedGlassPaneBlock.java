...
public class CyanHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:cyan_horizontal_stained_glass_pane")
	public static final Block block = null;
	public CyanHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 277);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("cyan_horizontal_stained_glass_pane");
		}
