...
public class StrippedBYGJacarandaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_jacaranda_wooden_slab")
	public static final Block block = null;
	public StrippedBYGJacarandaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 566);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_jacaranda_wooden_slab");
		}
