...
public class SandyBirchFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:sandy_birch_framed_cyan_stained_glass")
	public static final Block block = null;
	public SandyBirchFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 418);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("sandy_birch_framed_cyan_stained_glass");
		}
