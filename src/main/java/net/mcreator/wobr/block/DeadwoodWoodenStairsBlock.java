...
public class DeadwoodWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:deadwood_wooden_stairs")
	public static final Block block = null;
	public DeadwoodWoodenStairsBlock(WobrModElements instance) {
		super(instance, 482);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("deadwood_wooden_stairs");
		}
