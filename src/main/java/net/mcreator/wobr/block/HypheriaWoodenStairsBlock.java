...
public class HypheriaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:hypheria_wooden_stairs")
	public static final Block block = null;
	public HypheriaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 691);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("hypheria_wooden_stairs");
		}
