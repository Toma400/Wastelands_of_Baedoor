...
public class WarpedFramedLightBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_light_blue_stained_glass")
	public static final Block block = null;
	public WarpedFramedLightBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 448);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_light_blue_stained_glass");
		}
