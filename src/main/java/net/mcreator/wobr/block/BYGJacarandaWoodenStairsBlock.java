...
public class BYGJacarandaWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_jacaranda_wooden_stairs")
	public static final Block block = null;
	public BYGJacarandaWoodenStairsBlock(WobrModElements instance) {
		super(instance, 563);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_jacaranda_wooden_stairs");
		}
