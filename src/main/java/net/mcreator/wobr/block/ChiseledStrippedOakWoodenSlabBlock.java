...
public class ChiseledStrippedOakWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_oak_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedOakWoodenSlabBlock(WobrModElements instance) {
		super(instance, 98);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_oak_wooden_slab");
		}
