...
public class WarpedFramedWhiteStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_white_stained_glass")
	public static final Block block = null;
	public WarpedFramedWhiteStainedGlassBlock(WobrModElements instance) {
		super(instance, 461);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_white_stained_glass");
		}
