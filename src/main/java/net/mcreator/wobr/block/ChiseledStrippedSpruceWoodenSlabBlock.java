...
public class ChiseledStrippedSpruceWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_spruce_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedSpruceWoodenSlabBlock(WobrModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_spruce_wooden_slab");
		}
