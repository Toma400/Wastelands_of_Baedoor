...
public class StrippedBYGCypressWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_cypress_wooden_slab")
	public static final Block block = null;
	public StrippedBYGCypressWoodenSlabBlock(WobrModElements instance) {
		super(instance, 526);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_cypress_wooden_slab");
		}
