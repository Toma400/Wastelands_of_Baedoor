...
public class AcaciaFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_light_gray_stained_glass")
	public static final Block block = null;
	public AcaciaFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 294);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_light_gray_stained_glass");
		}
