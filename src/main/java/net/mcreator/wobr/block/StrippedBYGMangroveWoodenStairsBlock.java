...
public class StrippedBYGMangroveWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_mangrove_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGMangroveWoodenStairsBlock(WobrModElements instance) {
		super(instance, 591);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_mangrove_wooden_stairs");
		}
