...
public class BirchFramedLightGrayStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_light_gray_stained_glass")
	public static final Block block = null;
	public BirchFramedLightGrayStainedGlassBlock(WobrModElements instance) {
		super(instance, 321);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_light_gray_stained_glass");
		}
