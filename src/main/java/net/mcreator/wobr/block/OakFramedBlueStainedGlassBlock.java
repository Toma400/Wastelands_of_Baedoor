...
public class OakFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_blue_stained_glass")
	public static final Block block = null;
	public OakFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 384);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_blue_stained_glass");
		}
