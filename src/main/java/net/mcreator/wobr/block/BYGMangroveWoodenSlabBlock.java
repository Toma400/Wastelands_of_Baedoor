...
public class BYGMangroveWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_mangrove_wooden_slab")
	public static final Block block = null;
	public BYGMangroveWoodenSlabBlock(WobrModElements instance) {
		super(instance, 585);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_mangrove_wooden_slab");
		}
