...
public class StrippedPalmWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_palm_wooden_slab")
	public static final Block block = null;
	public StrippedPalmWoodenSlabBlock(WobrModElements instance) {
		super(instance, 483);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_palm_wooden_slab");
		}
