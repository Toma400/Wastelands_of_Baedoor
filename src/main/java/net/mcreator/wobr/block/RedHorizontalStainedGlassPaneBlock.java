...
public class RedHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_horizontal_stained_glass_pane")
	public static final Block block = null;
	public RedHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 272);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_horizontal_stained_glass_pane");
		}
