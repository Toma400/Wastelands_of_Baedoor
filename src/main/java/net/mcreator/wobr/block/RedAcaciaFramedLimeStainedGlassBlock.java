...
public class RedAcaciaFramedLimeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_lime_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedLimeStainedGlassBlock(WobrModElements instance) {
		super(instance, 379);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_lime_stained_glass");
		}
