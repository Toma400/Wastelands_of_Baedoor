...
public class ChiseledBYGBaobabWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_baobab_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGBaobabWoodenSlabBlock(WobrModElements instance) {
		super(instance, 499);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_baobab_wooden_slab");
		}
