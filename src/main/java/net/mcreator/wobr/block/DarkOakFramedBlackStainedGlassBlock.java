...
public class DarkOakFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dark_oak_framed_black_stained_glass")
	public static final Block block = null;
	public DarkOakFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 346);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dark_oak_framed_black_stained_glass");
		}
