...
public class StrippedBYGNightshadeWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_nightshade_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGNightshadeWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1902);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_nightshade_wooden_stairs");
		}
