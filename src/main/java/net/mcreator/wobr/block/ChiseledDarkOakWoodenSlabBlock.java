...
public class ChiseledDarkOakWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_dark_oak_wooden_slab")
	public static final Block block = null;
	public ChiseledDarkOakWoodenSlabBlock(WobrModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_dark_oak_wooden_slab");
		}
