...
public class ChiseledStrippedAcaciaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_acacia_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedAcaciaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 120);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_acacia_wooden_slab");
		}
