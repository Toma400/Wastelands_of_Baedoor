...
public class RedAcaciaFramedBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_blue_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 372);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_blue_stained_glass");
		}
