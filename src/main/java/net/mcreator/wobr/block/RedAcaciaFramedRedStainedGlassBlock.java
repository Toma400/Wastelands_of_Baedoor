...
public class RedAcaciaFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_red_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 384);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_red_stained_glass");
		}
