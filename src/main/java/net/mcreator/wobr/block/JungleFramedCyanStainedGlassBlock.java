...
public class JungleFramedCyanStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_cyan_stained_glass")
	public static final Block block = null;
	public JungleFramedCyanStainedGlassBlock(WobrModElements instance) {
		super(instance, 365);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_cyan_stained_glass");
		}
