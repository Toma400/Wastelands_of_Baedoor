...
public class SpruceFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_black_stained_glass")
	public static final Block block = null;
	public SpruceFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 426);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_black_stained_glass");
		}
