...
public class ChiseledBYGHollyWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_holly_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGHollyWoodenSlabBlock(WobrModElements instance) {
		super(instance, 555);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_holly_wooden_slab");
		}
