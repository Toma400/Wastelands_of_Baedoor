...
public class CrimsonFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_brown_stained_glass")
	public static final Block block = null;
	public CrimsonFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 332);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_brown_stained_glass");
		}
