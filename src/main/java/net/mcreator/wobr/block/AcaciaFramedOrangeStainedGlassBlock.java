...
public class AcaciaFramedOrangeStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:acacia_framed_orange_stained_glass")
	public static final Block block = null;
	public AcaciaFramedOrangeStainedGlassBlock(WobrModElements instance) {
		super(instance, 269);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("acacia_framed_orange_stained_glass");
		}
