...
public class BYGAspenWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_aspen_wooden_stairs")
	public static final Block block = null;
	public BYGAspenWoodenStairsBlock(WobrModElements instance) {
		super(instance, 2194);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_aspen_wooden_stairs");
		}
