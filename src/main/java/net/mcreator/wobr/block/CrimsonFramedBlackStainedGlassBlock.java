...
public class CrimsonFramedBlackStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:crimson_framed_black_stained_glass")
	public static final Block block = null;
	public CrimsonFramedBlackStainedGlassBlock(WobrModElements instance) {
		super(instance, 334);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("crimson_framed_black_stained_glass");
		}
