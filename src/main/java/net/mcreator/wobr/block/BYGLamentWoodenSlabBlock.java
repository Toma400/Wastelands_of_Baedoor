...
public class BYGLamentWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_lament_wooden_slab")
	public static final Block block = null;
	public BYGLamentWoodenSlabBlock(WobrModElements instance) {
		super(instance, 570);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_lament_wooden_slab");
		}
