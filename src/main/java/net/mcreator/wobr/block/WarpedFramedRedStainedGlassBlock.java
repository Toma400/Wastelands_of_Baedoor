...
public class WarpedFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:warped_framed_red_stained_glass")
	public static final Block block = null;
	public WarpedFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 455);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("warped_framed_red_stained_glass");
		}
