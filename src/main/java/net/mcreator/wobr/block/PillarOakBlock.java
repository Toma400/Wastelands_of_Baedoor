...
public class PillarOakBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:pillar_oak")
	public static final Block block = null;
	public PillarOakBlock(WobrModElements instance) {
		super(instance, 155);
	}
