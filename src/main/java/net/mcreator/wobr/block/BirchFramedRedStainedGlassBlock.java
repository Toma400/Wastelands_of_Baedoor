...
public class BirchFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:birch_framed_red_stained_glass")
	public static final Block block = null;
	public BirchFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 324);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("birch_framed_red_stained_glass");
		}
