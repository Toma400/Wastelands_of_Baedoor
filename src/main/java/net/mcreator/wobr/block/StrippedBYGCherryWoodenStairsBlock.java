...
public class StrippedBYGCherryWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_cherry_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGCherryWoodenStairsBlock(WobrModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_cherry_wooden_stairs");
		}
