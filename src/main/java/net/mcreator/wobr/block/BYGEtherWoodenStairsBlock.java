...
public class BYGEtherWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_ether_wooden_stairs")
	public static final Block block = null;
	public BYGEtherWoodenStairsBlock(WobrModElements instance) {
		super(instance, 521);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_ether_wooden_stairs");
		}
