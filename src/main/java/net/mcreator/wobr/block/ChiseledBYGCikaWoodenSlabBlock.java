...
public class ChiseledBYGCikaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_byg_cika_wooden_slab")
	public static final Block block = null;
	public ChiseledBYGCikaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 516);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_byg_cika_wooden_slab");
		}
