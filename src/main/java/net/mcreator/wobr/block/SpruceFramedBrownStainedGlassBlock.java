...
public class SpruceFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_brown_stained_glass")
	public static final Block block = null;
	public SpruceFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 428);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_brown_stained_glass");
		}
