...
public class RedAcaciaFramedBrownStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_brown_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedBrownStainedGlassBlock(WobrModElements instance) {
		super(instance, 396);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_brown_stained_glass");
		}
