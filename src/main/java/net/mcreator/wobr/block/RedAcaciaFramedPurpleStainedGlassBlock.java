...
public class RedAcaciaFramedPurpleStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_purple_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedPurpleStainedGlassBlock(WobrModElements instance) {
		super(instance, 383);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_purple_stained_glass");
		}
