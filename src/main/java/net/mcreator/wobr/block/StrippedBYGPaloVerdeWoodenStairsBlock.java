...
public class StrippedBYGPaloVerdeWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_palo_verde_wooden_stairs")
	public static final Block block = null;
	public StrippedBYGPaloVerdeWoodenStairsBlock(WobrModElements instance) {
		super(instance, 623);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_palo_verde_wooden_stairs");
		}
