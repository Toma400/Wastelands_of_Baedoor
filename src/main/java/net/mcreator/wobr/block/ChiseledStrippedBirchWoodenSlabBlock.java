...
public class ChiseledStrippedBirchWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_birch_wooden_slab")
	public static final Block block = null;
	public ChiseledStrippedBirchWoodenSlabBlock(WobrModElements instance) {
		super(instance, 112);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_birch_wooden_slab");
		}
