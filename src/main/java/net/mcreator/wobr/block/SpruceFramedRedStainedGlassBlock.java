...
public class SpruceFramedRedStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:spruce_framed_red_stained_glass")
	public static final Block block = null;
	public SpruceFramedRedStainedGlassBlock(WobrModElements instance) {
		super(instance, 439);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("spruce_framed_red_stained_glass");
		}
