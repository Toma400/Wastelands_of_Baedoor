...
public class ChiseledStrippedOakWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_stripped_oak_wood")
	public static final Block block = null;
	public ChiseledStrippedOakWoodBlock(WobrModElements instance) {
		super(instance, 96);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_stripped_oak_wood");
		}
