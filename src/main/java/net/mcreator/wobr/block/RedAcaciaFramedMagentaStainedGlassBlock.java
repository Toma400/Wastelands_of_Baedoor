...
public class RedAcaciaFramedMagentaStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:red_acacia_framed_magenta_stained_glass")
	public static final Block block = null;
	public RedAcaciaFramedMagentaStainedGlassBlock(WobrModElements instance) {
		super(instance, 380);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("red_acacia_framed_magenta_stained_glass");
		}
