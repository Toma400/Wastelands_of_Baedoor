...
public class JungleFramedYellowStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:jungle_framed_yellow_stained_glass")
	public static final Block block = null;
	public JungleFramedYellowStainedGlassBlock(WobrModElements instance) {
		super(instance, 354);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("jungle_framed_yellow_stained_glass");
		}
