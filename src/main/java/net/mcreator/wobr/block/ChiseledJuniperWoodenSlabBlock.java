...
public class ChiseledJuniperWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_juniper_wooden_slab")
	public static final Block block = null;
	public ChiseledJuniperWoodenSlabBlock(WobrModElements instance) {
		super(instance, 496);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_juniper_wooden_slab");
		}
