...
public class StrippedBYGPalmWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_byg_palm_wooden_slab")
	public static final Block block = null;
	public StrippedBYGPalmWoodenSlabBlock(WobrModElements instance) {
		super(instance, 1911);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_byg_palm_wooden_slab");
		}
