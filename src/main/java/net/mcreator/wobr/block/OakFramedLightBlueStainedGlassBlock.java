...
public class OakFramedLightBlueStainedGlassBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:oak_framed_light_blue_stained_glass")
	public static final Block block = null;
	public OakFramedLightBlueStainedGlassBlock(WobrModElements instance) {
		super(instance, 388);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("oak_framed_light_blue_stained_glass");
		}
