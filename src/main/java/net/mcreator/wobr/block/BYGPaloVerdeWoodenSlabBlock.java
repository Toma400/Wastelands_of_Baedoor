...
public class BYGPaloVerdeWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_palo_verde_wooden_slab")
	public static final Block block = null;
	public BYGPaloVerdeWoodenSlabBlock(WobrModElements instance) {
		super(instance, 618);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_palo_verde_wooden_slab");
		}
