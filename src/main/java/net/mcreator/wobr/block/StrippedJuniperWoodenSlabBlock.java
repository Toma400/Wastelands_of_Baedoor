...
public class StrippedJuniperWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_juniper_wooden_slab")
	public static final Block block = null;
	public StrippedJuniperWoodenSlabBlock(WobrModElements instance) {
		super(instance, 493);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_juniper_wooden_slab");
		}
