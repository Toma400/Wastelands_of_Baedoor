...
public class BYGSkyrisWoodenStairsBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:byg_skyris_wooden_stairs")
	public static final Block block = null;
	public BYGSkyrisWoodenStairsBlock(WobrModElements instance) {
		super(instance, 1937);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("byg_skyris_wooden_stairs");
		}
