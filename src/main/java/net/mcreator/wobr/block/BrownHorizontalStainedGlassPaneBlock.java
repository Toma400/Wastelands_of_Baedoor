...
public class BrownHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:brown_horizontal_stained_glass_pane")
	public static final Block block = null;
	public BrownHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 270);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_horizontal_stained_glass_pane");
		}
