...
public class StrippedSpruceWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stripped_spruce_wooden_slab")
	public static final Block block = null;
	public StrippedSpruceWoodenSlabBlock(WobrModElements instance) {
		super(instance, 127);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("stripped_spruce_wooden_slab");
		}
