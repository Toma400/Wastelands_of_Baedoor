...
public class BrownShroomedWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:brown_shroomed_wooden_slab")
	public static final Block block = null;
	public BrownShroomedWoodenSlabBlock(WobrModElements instance) {
		super(instance, 643);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("brown_shroomed_wooden_slab");
		}
