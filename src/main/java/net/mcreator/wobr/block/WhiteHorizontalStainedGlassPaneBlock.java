...
public class WhiteHorizontalStainedGlassPaneBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:white_horizontal_stained_glass_pane")
	public static final Block block = null;
	public WhiteHorizontalStainedGlassPaneBlock(WobrModElements instance) {
		super(instance, 266);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("white_horizontal_stained_glass_pane");
		}
