...
public class ChiseledAcaciaWoodenSlabBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_acacia_wooden_slab")
	public static final Block block = null;
	public ChiseledAcaciaWoodenSlabBlock(WobrModElements instance) {
		super(instance, 119);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseled_acacia_wooden_slab");
		}
