...
public class ChiseledDarkOakWoodBlock extends WobrModElements.ModElement {
	@ObjectHolder("wobr:chiseled_dark_oak_wood")
	public static final Block block = null;
	public ChiseledDarkOakWoodBlock(WobrModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("chiseled_dark_oak_wood");
		}
