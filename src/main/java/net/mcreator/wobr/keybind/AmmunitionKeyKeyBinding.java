...
import net.mcreator.wobr.procedures.AmmunitionCheckProcedure;
...
public class AmmunitionKeyKeyBinding extends WobrModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
		...
		if (type == 0) {
			{
				...
				AmmunitionCheckProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
