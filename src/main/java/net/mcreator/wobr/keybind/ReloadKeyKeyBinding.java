...
import net.mcreator.wobr.procedures.ReloadScoreProcedure;
...
public class ReloadKeyKeyBinding extends WobrModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
		...
		if (type == 0) {
			{
				...
				ReloadScoreProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
