...
import net.mcreator.wobr.procedures.ModeCheckProcedure;
...
public class ModeChangeKeyKeyBinding extends WobrModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
		...
		if (type == 0) {
			{
				...
				ModeCheckProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
