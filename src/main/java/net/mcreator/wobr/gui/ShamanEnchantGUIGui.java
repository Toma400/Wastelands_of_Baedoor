...
import net.mcreator.wobr.procedures.ShamanTreatmentProcedure;
import net.mcreator.wobr.procedures.ShamanMsgResetProcedure;
import net.mcreator.wobr.procedures.ShamanBlessingProcedure;
...
public class ShamanEnchantGUIGui extends WobrModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public ShamanEnchantGUIGui(WobrModElements instance) {
		super(instance, 1250);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("shaman_enchant_gui"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			}
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ShamanMsgResetProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("" + (entity.getPersistentData().getDouble("ormath_reputation")) + "", 76, 150, -9347962);
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 83, this.guiTop + 24, 13, 20, "?", e -> {
				if (true) {
					WobrMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
					handleButtonAction(entity, 0, x, y, z);
				}
			}));
			this.addButton(new Button(this.guiLeft + 84, this.guiTop + 104, 12, 20, "?", e -> {
				if (true) {
		...
		if (buttonID == 0) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ShamanTreatmentProcedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ShamanBlessingProcedure.executeProcedure($_dependencies);
			}
		}
	}
