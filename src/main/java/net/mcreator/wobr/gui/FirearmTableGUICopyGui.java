...
public class FirearmTableGUICopyGui extends WobrModElements.ModElement {
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("firearm_table_gui_copy"));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 79, 59) {
				@Override
				public ItemStack onTake(PlayerEntity entity, ItemStack stack) {
					ItemStack retval = super.onTake(entity, stack);
			...
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 104, 35) {
				@Override
				public ItemStack onTake(PlayerEntity entity, ItemStack stack) {
					ItemStack retval = super.onTake(entity, stack);
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		private static final ResourceLocation texture = new ResourceLocation("wobr:textures/firearm_table_gui_copy.png");
		@Override
		...
		protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
			...
			this.blit(this.guiLeft + 80, this.guiTop + 35, 0, 0, 256, 256, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("wobr:textures/grey_barrel.png"));
			this.blit(this.guiLeft + 105, this.guiTop + 36, 0, 0, 256, 256, 256, 256);
			...
			this.blit(this.guiLeft + 53, this.guiTop + 34, 0, 0, 256, 256, 256, 256);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("wobr:textures/scheme.png"));
			this.blit(this.guiLeft + 82, this.guiTop + 61, 0, 0, 256, 256, 256, 256);
		...
		public void init(Minecraft minecraft, int width, int height) {
			...
			this.addButton(new Button(this.guiLeft + 123, this.guiTop + 32, 6, 20, "»", e -> {
				WobrMod.PACKET_HANDLER.sendToServer(new ButtonPressedMessage(0, x, y, z));
				handleButtonAction(entity, 0, x, y, z);
			}));
			this.addButton(new Button(this.guiLeft + 44, this.guiTop + 32, 7, 20, "«", e -> {
