...
public class MerchantGUI3Gui extends WobrModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public MerchantGUI3Gui(WobrModElements instance) {
		super(instance, 1402);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("merchant_gui_3"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("Vulcanic Veil", 227, 94, -4684786);
