...
import net.mcreator.wobr.procedures.OrmathTrade4Procedure;
import net.mcreator.wobr.procedures.OrmathTrade3Procedure;
...
public class VillagerTradeGUI2Gui extends WobrModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public VillagerTradeGUI2Gui(WobrModElements instance) {
		super(instance, 1332);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("villager_trade_gui_2"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("1", 115, 43, -16737895);
			this.font.drawString("8", 30, 43, -16737895);
			this.font.drawString("32", 27, 67, -16737895);
			this.font.drawString("1", 115, 67, -16737895);
			...
			this.font.drawString("" + ((entity.getCapability(WobrModVariables.PLAYER_VARIABLES_CAPABILITY, null)
					.orElse(new WobrModVariables.PlayerVariables())).Ormath_Reputation) + "", 78, 147, -9347962);
			this.font.drawString("" + ((entity.getCapability(WobrModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (buttonID == 0) {
			{
				...
				$_dependencies.put("world", world);
				OrmathTrade3Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				OrmathTrade4Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
