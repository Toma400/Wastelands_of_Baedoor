...
import net.mcreator.wobr.procedures.ShamanTrade4Procedure;
import net.mcreator.wobr.procedures.ShamanTrade3Procedure;
import net.mcreator.wobr.procedures.ShamanTrade2Procedure;
import net.mcreator.wobr.procedures.ShamanTrade1Procedure;
import net.mcreator.wobr.procedures.ShamanToPage2Procedure;
...
public class ShamanTradeGUIGui extends WobrModElements.ModElement {
	...
	public ShamanTradeGUIGui(WobrModElements instance) {
		super(instance, 1155);
	...
	public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
		event.getRegistry().register(containerType.setRegistryName("shaman_trade_gui"));
	}
	...
	public static class GuiWindow extends ContainerScreen<GuiContainerMod> {
		...
		protected void drawGuiContainerBackgroundLayer(float partialTicks, int gx, int gy) {
			...
			this.blit(this.guiLeft + 128, this.guiTop + 40, 0, 0, 16, 16, 16, 16);
			...
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("wobr:textures/tsua_flower.png"));
			this.blit(this.guiLeft + 127, this.guiTop + 64, 0, 0, 16, 16, 16, 16);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("wobr:textures/wither_rose.png"));
			this.blit(this.guiLeft + 127, this.guiTop + 86, 0, 0, 16, 16, 16, 16);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("wobr:textures/baedoor_funt_2.png"));
			this.blit(this.guiLeft + 42, this.guiTop + 87, 0, 0, 16, 16, 16, 16);
			Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("wobr:textures/curare.png"));
		...
		protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
			this.font.drawString("16", 113, 43, -16737895);
			this.font.drawString("1", 36, 43, -16737895);
			this.font.drawString("1", 36, 67, -16737895);
			this.font.drawString("4", 116, 67, -16737895);
			this.font.drawString("1", 116, 90, -16737895);
			this.font.drawString("1", 36, 90, -16737895);
			this.font.drawString("1", 116, 112, -16737895);
			...
			this.font.drawString("" + ((entity.getCapability(WobrModVariables.PLAYER_VARIABLES_CAPABILITY, null)
					.orElse(new WobrModVariables.PlayerVariables())).Ormath_Reputation) + "", 76, 150, -9347962);
			this.font.drawString("" + ((entity.getCapability(WobrModVariables.PLAYER_VARIABLES_CAPABILITY, null)
		...
		if (buttonID == 0) {
			{
				...
				$_dependencies.put("world", world);
				ShamanTrade1Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 1) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ShamanTrade2Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 2) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ShamanTrade3Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 3) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ShamanTrade4Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 4) {
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ShamanToPage2Procedure.executeProcedure($_dependencies);
			}
		}
		if (buttonID == 5) {
			{
