...
public class LargeAirshipJungleStructure extends WobrModElements.ModElement {
	public LargeAirshipJungleStructure(WobrModElements instance) {
		super(instance, 1446);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 800) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("wobr", "spawn_block_airship_bamboo"));
						if (template == null)
							return false;
