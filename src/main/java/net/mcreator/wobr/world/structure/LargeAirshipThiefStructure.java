...
public class LargeAirshipThiefStructure extends WobrModElements.ModElement {
	public LargeAirshipThiefStructure(WobrModElements instance) {
		super(instance, 861);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 200) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("wobr", "spawn_block_airship_bandit"));
						if (template == null)
							return false;
