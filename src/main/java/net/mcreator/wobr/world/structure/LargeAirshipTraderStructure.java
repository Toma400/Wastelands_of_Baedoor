...
public class LargeAirshipTraderStructure extends WobrModElements.ModElement {
	public LargeAirshipTraderStructure(WobrModElements instance) {
		super(instance, 862);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 240) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("wobr", "spawn_block_airship_trader"));
						if (template == null)
							return false;
