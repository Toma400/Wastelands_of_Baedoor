...
public class LargeAirshipMilitaryStructure extends WobrModElements.ModElement {
	public LargeAirshipMilitaryStructure(WobrModElements instance) {
		super(instance, 792);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 200) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("wobr", "spawn_block_airship_military"));
						if (template == null)
							return false;
