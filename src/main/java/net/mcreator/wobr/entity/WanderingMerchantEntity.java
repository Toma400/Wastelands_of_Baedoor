...
public class WanderingMerchantEntity extends WobrModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 2f)).build("wandering_merchant")
						.setRegistryName("wandering_merchant");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -13434778, new Item.Properties().group(WoBCreativeTabItemGroup.tab))
				.setRegistryName("wandering_merchant_spawn_egg"));
	}
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Wandering Merchant");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new MerchantGUIResourcesGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
