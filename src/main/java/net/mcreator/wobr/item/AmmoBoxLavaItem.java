...
import net.mcreator.wobr.procedures.ShotLavaAmmoBoxProcedure;
...
public class AmmoBoxLavaItem extends WobrModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Lava-based ammunition box"));
				list.add(new StringTextComponent("able to store large bullets"));
			}
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					ShotLavaAmmoBoxProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		...
		}.setRegistryName("ammo_box_lava"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(WoBCreativeTabItemGroup.tab).maxDamage(0));
		}
