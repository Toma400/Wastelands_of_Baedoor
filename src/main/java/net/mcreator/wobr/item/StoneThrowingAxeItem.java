...
import net.mcreator.wobr.procedures.StoneThrowingAxeCollisionProcedure;
...
public class StoneThrowingAxeItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:stone_throwing_axe")
	public static final Item block = null;
	@ObjectHolder("wobr:entitybulletstone_throwing_axe")
	public static final EntityType arrow = null;
	public StoneThrowingAxeItem(WobrModElements instance) {
		super(instance, 29);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletstone_throwing_axe").setRegistryName("entitybulletstone_throwing_axe"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(WoBCreativeTabItemGroup.tab).maxStackSize(8));
			...
			if (this.inGround) {
				{
					...
					StoneThrowingAxeCollisionProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
