...
public class BulletRangedBanditDespawningItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bullet_ranged_bandit_despawning")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("bullet_ranged_bandit_despawning");
		}
			...
			if (this.inGround) {
				{
					...
					BulletGroundHitProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
