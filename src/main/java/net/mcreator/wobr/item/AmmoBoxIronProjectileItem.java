...
import net.mcreator.wobr.procedures.ExplosionIronAmmoBoxProcedure;
...
public class AmmoBoxIronProjectileItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:ammo_box_iron_projectile")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("ammo_box_iron_projectile");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AmmoBoxIronItem.block, (int) (1));
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				ExplosionIronAmmoBoxProcedure.executeProcedure($_dependencies);
			}
		}
