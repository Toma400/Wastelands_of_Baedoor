...
import net.mcreator.wobr.procedures.WindProjectileLevitationProcedure;
import net.mcreator.wobr.procedures.WindProjectileGroundProcedure;
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				WindProjectileLevitationProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					WindProjectileGroundProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
