...
public class BoneThrowingAxeItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:bone_throwing_axe")
	public static final Item block = null;
	@ObjectHolder("wobr:entitybulletbone_throwing_axe")
			...
			if (this.inGround) {
				{
					...
					BoneThrowingAxeCollisionProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
