...
import net.mcreator.wobr.procedures.DartCurareUseProcedure;
...
public class DartCurareProjectileItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dart_curare_projectile")
	public static final Item block = null;
	@ObjectHolder("wobr:entitybulletdart_curare_projectile")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("dart_curare_projectile");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				DartCurareUseProcedure.executeProcedure($_dependencies);
			}
		}
