...
import net.mcreator.wobr.procedures.PoisonedThrownDaggerCollisionProcedure;
import net.mcreator.wobr.procedures.MushroomLongPoisoningProcedure;
...
public class PoisonedThrownDaggerItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:poisoned_thrown_dagger")
	public static final Item block = null;
	@ObjectHolder("wobr:entitybulletpoisoned_thrown_dagger")
	public static final EntityType arrow = null;
	public PoisonedThrownDaggerItem(WobrModElements instance) {
		super(instance, 13);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletpoisoned_thrown_dagger").setRegistryName("entitybulletpoisoned_thrown_dagger"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(WoBCreativeTabItemGroup.tab).maxStackSize(16));
			setRegistryName("poisoned_thrown_dagger");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				MushroomLongPoisoningProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					PoisonedThrownDaggerCollisionProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
