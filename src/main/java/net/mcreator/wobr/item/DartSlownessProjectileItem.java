...
import net.mcreator.wobr.procedures.DartSlownessUseProcedure;
...
public class DartSlownessProjectileItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:dart_slowness_projectile")
	public static final Item block = null;
	@ObjectHolder("wobr:entitybulletdart_slowness_projectile")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("dart_slowness_projectile");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				...
				DartSlownessUseProcedure.executeProcedure($_dependencies);
			}
		}
