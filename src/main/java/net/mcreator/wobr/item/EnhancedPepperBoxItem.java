...
import net.mcreator.wobr.procedures.ShotEnhancedPepperBoxProcedure;
...
public class EnhancedPepperBoxItem extends WobrModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.posZ;
				{
					...
					ShotEnhancedPepperBoxProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		...
		}.setRegistryName("enhanced_pepper_box"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(WoBCreativeTabItemGroup.tab).maxDamage(177));
		}
