...
import net.mcreator.wobr.procedures.ShotRustyReaperProcedure;
...
public class RustyReaperItem extends WobrModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Enhanced shotgun with improved cylinder functioning, which makes it much more reliable to use"));
			}
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					ShotRustyReaperProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
		...
		}.setRegistryName("rusty_reaper"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(WoBCreativeTabItemGroup.tab).maxDamage(266));
		}
