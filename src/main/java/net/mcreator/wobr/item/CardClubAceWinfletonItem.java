...
public class CardClubAceWinfletonItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:card_club_ace_winfleton")
	public static final Item block = null;
	public CardClubAceWinfletonItem(WobrModElements instance) {
		super(instance, 223);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("card_club_ace_winfleton");
		}
