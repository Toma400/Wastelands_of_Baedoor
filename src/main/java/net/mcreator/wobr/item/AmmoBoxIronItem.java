...
import net.mcreator.wobr.procedures.ShotIronAmmoBoxProcedure;
...
public class AmmoBoxIronItem extends WobrModElements.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Iron-based ammunition box"));
				list.add(new StringTextComponent("able to store small bullets"));
			}
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					ShotIronAmmoBoxProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
