...
import net.mcreator.wobr.procedures.PulsatingJavelinTagKillProcedure;
import net.mcreator.wobr.procedures.PulsatingJavelinTagKillBlockProcedure;
...
public class PulsatingJavelinItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:pulsating_javelin")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletpulsating_javelin").setRegistryName("entitybulletpulsating_javelin");
	public PulsatingJavelinItem(WobrModElements instance) {
		super(instance, 18);
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				...
				PulsatingJavelinTagKillProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					$_dependencies.put("z", z);
					$_dependencies.put("world", world);
					PulsatingJavelinTagKillBlockProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
