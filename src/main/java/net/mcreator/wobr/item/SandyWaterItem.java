...
public class SandyWaterItem extends WobrModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Sandy water, feels like it can be useful for something?"));
		}
	}
}
