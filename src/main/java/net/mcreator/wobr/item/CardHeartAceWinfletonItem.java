...
public class CardHeartAceWinfletonItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:card_heart_ace_winfleton")
	public static final Item block = null;
	public CardHeartAceWinfletonItem(WobrModElements instance) {
		super(instance, 224);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("card_heart_ace_winfleton");
		}
