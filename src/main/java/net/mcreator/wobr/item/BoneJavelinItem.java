...
import net.mcreator.wobr.procedures.BoneJavelinSlownessProcedure;
import net.mcreator.wobr.procedures.BoneJavelinCollisionProcedure;
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			Entity imediatesourceentity = this;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				BoneJavelinSlownessProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					BoneJavelinCollisionProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
