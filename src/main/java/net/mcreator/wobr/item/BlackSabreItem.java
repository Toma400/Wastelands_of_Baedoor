...
public class BlackSabreItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:black_sabre")
	public static final Item block = null;
	public BlackSabreItem(WobrModElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("This sabre is beautiful and powerful, but everything what's great comes with a price..."));
			}
