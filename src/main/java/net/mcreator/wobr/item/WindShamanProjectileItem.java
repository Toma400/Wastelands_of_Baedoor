...
import net.mcreator.wobr.procedures.ShamanProjectileSpiritProcedure;
import net.mcreator.wobr.procedures.ShamanProjectileEntityProcedure;
import net.mcreator.wobr.procedures.ShamanIronGolemCrackingProcedure;
...
public class WindShamanProjectileItem extends WobrModElements.ModElement {
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("wind_shaman_projectile");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 0, 2);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				ShamanProjectileEntityProcedure.executeProcedure($_dependencies);
			}
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			World world = this.world;
			{
				Map<String, Object> $_dependencies = new HashMap<>();
				$_dependencies.put("entity", entity);
				ShamanIronGolemCrackingProcedure.executeProcedure($_dependencies);
			}
		}
			...
			if (this.inGround) {
				{
					...
					ShamanProjectileSpiritProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
	...
	public static ArrowCustomEntity shoot(LivingEntity entity, LivingEntity target) {
		...
		entityarrow.shoot(d1, d0 - entityarrow.posY + (double) MathHelper.sqrt(d1 * d1 + d3 * d3) * 0.2F, d3, 2f * 2, 12.0F);
		entityarrow.setSilent(true);
