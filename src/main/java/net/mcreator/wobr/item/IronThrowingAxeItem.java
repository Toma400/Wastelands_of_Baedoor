...
import net.mcreator.wobr.procedures.IronThrowingAxeCollisionProcedure;
...
public class IronThrowingAxeItem extends WobrModElements.ModElement {
	@ObjectHolder("wobr:iron_throwing_axe")
	public static final Item block = null;
	@ObjectHolder("wobr:entitybulletiron_throwing_axe")
			...
			if (this.inGround) {
				{
					...
					IronThrowingAxeCollisionProcedure.executeProcedure($_dependencies);
				}
				this.remove();
			}
		}
