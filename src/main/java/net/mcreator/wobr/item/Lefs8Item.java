...
import net.mcreator.wobr.procedures.ShotLefs8Procedure;
...
public class Lefs8Item extends WobrModElements.ModElement {
	@ObjectHolder("wobr:lefs_8")
	public static final Item block = null;
	public Lefs8Item(WobrModElements instance) {
		super(instance, 1856);
	}
		...
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent(
						"Regular revolver produced by Lefs Factories. Used by both commoners and gunslingers because of its complexity and balanced characteristics."));
			}
			...
			public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
				...
				double z = entity.getPosZ();
				{
					...
					ShotLefs8Procedure.executeProcedure($_dependencies);
				}
				return retval;
			}
